...
;(function(Live2DCubismCore) {
	...
	var _em_module = (function() {
		...
		return (
			...
			function(_em_module) {
				var b
				;(_em_module = _em_module || {}), (b = b || (void 0 !== _em_module ? _em_module : {}))
				var n,
					l = {}
				...
				r
					? ((u = __dirname + '/'),
					  ...
					  (w = function(a) {
							return (a = v(a, !0)).buffer || (a = new Uint8Array(a)), assert(a.buffer), a
					  }),
					...
					return {
						exports: (function(asmLibraryArg, wasmMemory, wasmTable) {
							...
							return (
								...
								T(2572, 'Cw=='),
								T(2611, '//////8='),
								T(2680, 'GBgAAC0rICAgMFgweAAobnVsbCkAAAAAEQAKABEREQAAAAAFAAAAAAAACQAAAAAL'),
									...
									if (((L = Gf = (L - 32) | 0), 1 <= (0 | df)))
										for (
											Of = ((Bf = q[(a + 4) >> 2]) + -1) | 0,
												...
												Rf = Mf = (((Kf = w(Hf, (Cf = (Bf + 1) | 0))) << 3) + mf) | 0,
												Sf = Nf = (((Bf + Kf) << 3) + mf) | 0,
												If = x(0 | Hf),
												Jf = x(0 | Bf),
												_f = q[(a + 8) >> 2],
											...
											;(lf = u[(4 + (ef = ((Ff = a << 3) + bf) | 0)) >> 2]),
												...
												(ff = x(nf * Jf)),
												(ef = lf >= x(1))
											a: if ((lf < x(0)) ^ 1 && !(ef | (nf >= x(1)) | (nf < x(0))))
												(ef = x(y((sf = gf))) < x(2147483648) ? ~~gf : -2147483648),
													(kf = x(sf - x(0 | ef))),
													(hf = x(y((gf = ff))) < x(2147483648) ? ~~ff : -2147483648),
													(jf = x(gf - x(0 | hf))),
													(ef = (hf + w(ef, Cf)) | 0),
													(gf = _f
														? ((ff = x(x(1) - kf)),
														  ...
														  (u[(cf + Ff) >> 2] =
																x(
																	x(x(ff * x(gf * u[hf >> 2])) + x(ff * x(jf * u[(hf + 8) >> 2]))) +
																		x(kf * x(gf * u[ef >> 2]))
																) + x(kf * x(jf * u[(ef + 8) >> 2]))),
														  (ff = x(
																x(
														...
														? ((ff = x(x(x(1) - jf) - kf)),
														  ...
														  (ef = (((ef + Cf) << 3) + mf) | 0),
														  (u[(cf + Ff) >> 2] =
																x(x(ff * u[hf >> 2]) + x(jf * u[(hf + 8) >> 2])) +
																x(kf * u[ef >> 2])),
														  (ff = x(x(ff * u[(hf + 4) >> 2]) + x(jf * u[(hf + 12) >> 2]))),
														  x(kf * u[(ef + 4) >> 2]))
														: ((ff = x(x(jf + x(-1)) + kf)),
														  (hf = (((ef + Cf) << 3) + mf) | 0),
														  (gf = x(x(1) - jf)),
														  ...
														  (ef = ((ef << 3) + mf) | 0),
														  (u[(cf + Ff) >> 2] =
																x(x(ff * u[(hf + 8) >> 2]) + x(gf * u[hf >> 2])) +
																x(lf * u[(ef + 8) >> 2])),
														  (ff = x(x(ff * u[(hf + 12) >> 2]) + x(gf * u[(hf + 4) >> 2]))),
														  x(lf * u[(ef + 12) >> 2])))
											else {
												if (
													($f ||
														...
														(rf = x(x(rf + qf) * x(0.5))),
														($f = 1),
														(of = x(x(x(x(x(Tf + Uf) + Vf) + sf) * x(0.25)) - x(of * x(0.5)))),
														(qf = x(x(x(x(x(Xf + Yf) + Zf) + Wf) * x(0.25)) - x(qf * x(0.5))))),
													!(
														((lf < x(3)) ^ 1) |
														((nf > x(-2)) ^ 1) |
														(((nf < x(3)) ^ 1) | ((lf > x(-2)) ^ 1))
													...
													b: if (nf <= x(0)) {
														...
														;(ff = x(of - x(pf + pf))),
															(ef = Pf),
															(hf = x(y(gf)) < x(2147483648) ? ~~gf : -2147483648),
															(kf = x(0 | (ef = (0 | hf) == (0 | Hf) ? ef : hf))),
															(jf = x(kf / If)),
															(vf = x(x(jf * tf) + ff)),
															(sf = x(jf * uf)),
															(jf = x(qf - x(rf + rf))),
														...
														lf <= x(0)
															? ((kf = x(x(lf + x(2)) * x(0.5))),
															  ...
															  (zf = u[(4 + (ef = ((ef << 3) + mf) | 0)) >> 2]),
															  (Af = u[ef >> 2]),
															  (xf = u[(4 + (ef = ((hf << 3) + mf) | 0)) >> 2]),
															  (yf = u[ef >> 2]))
															: ef
															? ((sf = gf = x(tf * x(3))),
															  (ef = Of),
															  (hf = x(y(ff)) < x(2147483648) ? ~~ff : -2147483648),
															  (jf = x(0 | (ef = (0 | hf) == (0 | Bf) ? ef : hf))),
															  (kf = x(jf / Jf)),
															  ...
															  (kf = x(x(lf + x(-1)) * x(0.5))),
															  (jf = x(ff - jf)),
															  (vf = u[(4 + (ef = (((ef + Kf) << 3) + mf) | 0)) >> 2]),
															  (wf = u[ef >> 2]),
															  (Df = u[(4 + (ef = (((hf + Kf) << 3) + mf) | 0)) >> 2]),
															  (Ef = u[ef >> 2]))
															: ((v[(16 + Gf) >> 3] = lf),
															  (q[Gf >> 2] = a),
															  (v[(8 + Gf) >> 3] = nf),
															  Y(4, 1104, Gf))
													if (x(jf + kf) <= x(1)) {
														;(u[(cf + Ff) >> 2] = x(wf + x(x(Ef - wf) * jf)) + x(x(Af - wf) * kf)),
													...
													;(ff = x(x(1) - jf)),
														(gf = x(x(1) - kf)),
														(u[(cf + Ff) >> 2] = x(yf + x(x(Af - yf) * ff)) + x(x(Ef - yf) * gf)),
								...
								(n[2] = function(a, qe, re) {
									...
									;(re = (q[(re + 4) >> 2] + (Fe << 5)) | 0),
										(Fe = q[(Ge + 20) >> 2]),
										n[q[(re + 20) >> 2]](q[(re + 24) >> 2], Fe, Fe, q[(Ge + 12) >> 2]),
										(qe <<= 2),
										(a = q[(a + 4) >> 2] << 2),
									...
									if (
										...
										(Le = (function(a) {
											var Rb,
												...
												Tb = 0
											;(L = Rb = (L - 16) | 0), j(a)
											a: if ((Qb = 2147483647 & (Sb = e(0))) >>> 0 <= 1061752794) {
												if (((Pb = x(1)), Qb >>> 0 < 964689920)) break a
												Pb = aa(+a)
											} else if (Qb >>> 0 <= 1081824209) {
												if (((Tb = +a), 1075235812 <= Qb >>> 0)) {
													Pb = x(-aa(((0 | Sb) < 0 ? 3.141592653589793 : -3.141592653589793) + Tb))
													break a
												}
												if ((0 | Sb) <= -1) {
												...
												if (1085271520 <= Qb >>> 0) {
													Pb = aa(+a + ((0 | Sb) < 0 ? 6.283185307179586 : -6.283185307179586))
													break a
												}
												if ((0 | Sb) <= -1) {
											...
											return (L = (16 + Rb) | 0), (a = Pb)
										})(
											(Ke = x(x(x(u[a >> 2] + u[(a + 20) >> 2]) * x(3.1415927410125732)) / x(180)))
										)),
										(Me = u[(a + 8) >> 2]),
										(Se = q[(a + 24) >> 2]),
										(Ke = (function(a) {
											var Mb,
												...
												Ob = 0
											;(L = Mb = (L - 16) | 0), j(a)
											a: if ((Fb = 2147483647 & (Ob = e(0))) >>> 0 <= 1061752794) {
												...
												a = $(-(((0 | Ob) < 0 ? 3.141592653589793 : -3.141592653589793) + Nb))
												...
												a = $(((0 | Ob) < 0 ? 6.283185307179586 : -6.283185307179586) + Nb)
								...
								(n[4] = function(a, qe, re) {
									...
									if (
										...
										;(ue = q[(re + 4) >> 2]),
											...
											(q[(60 + se) >> 2] = re),
											(q[(56 + se) >> 2] = xe),
											n[q[(ue + 20) >> 2]](q[(ue + 24) >> 2], (56 + se) | 0, (48 + se) | 0, 1),
											(ye = x(1)),
											(xe = 9)
										b: {
											for (;;) {
												if (
													...
													n[q[(ue + 20) >> 2]](q[(ue + 24) >> 2], (32 + se) | 0, (40 + se) | 0, 1),
												...
												if (((xe = (re + -1) | 0), (ye = x(ye * x(0.10000000149011612))), !re))
													break
											}
											Y(3, 1265, 0)
										}
										;(ve = (function(a, dh) {
											...
											if (
												(eh = x(
													Aa(u[(a + 4) >> 2], u[a >> 2]) - Aa(u[(dh + 4) >> 2], u[dh >> 2])
												)) < x(-3.1415927410125732)
											)
												for (; (eh = x(eh + x(6.2831854820251465))) < x(-3.1415927410125732); );
											if (eh > x(3.1415927410125732))
												for (; (eh = x(eh + x(-6.2831854820251465))) > x(3.1415927410125732); );
											return eh
										})((16 + se) | 0, (8 + se) | 0)),
											n[q[(ue + 20) >> 2]](q[(ue + 24) >> 2], (24 + se) | 0, (24 + se) | 0, 1),
											(q[(te + 12) >> 2] = q[(24 + se) >> 2]),
											(q[(te + 16) >> 2] = q[(28 + se) >> 2]),
											(u[(te + 20) >> 2] =
												u[(te + 20) >> 2] + x(x(ve * x(-180)) / x(3.1415927410125732))),
											(qe <<= 2),
											(a = q[(a + 4) >> 2] << 2),
								...
								(n[5] = function(a) {
									...
									if (
										...
										for (
											dg = q[(a + 236) >> 2], ag = q[(a + 216) >> 2], df = q[(a + 224) >> 2];
											(u[((cf = bf << 2) + dg) >> 2] = u[(cf + df) >> 2] * u[(cf + ag) >> 2]),
												(0 | bg) != (0 | (bf = (bf + 1) | 0));
									...
									if (1 <= (0 | hg))
										for (mg = q[(a + 208) >> 2], bg = dg = 0; ; ) {
											if (q[fg >> 2]) {
												gg = ((df = q[((cf = dg << 2) + q[(a + 212) >> 2]) >> 2]) + bg) | 0
												c: {
													if ((0 | df) <= 0) q[(cf + q[(a + 276) >> 2]) >> 2] = 0
													else {
														for (
												...
												if (
													...
													(q[bf >> 2] = ag),
													(ag = (bf = q[(12 + (((dg << 4) + lg) | 0)) >> 2]) << 1),
													(ig = q[(cf + q[(a + 272) >> 2]) >> 2]),
													(bf = (0 | bf) < 1) || ba(ig, 0, (1 < (0 | ag) ? ag : 1) << 2),
													!(bf | ((0 | df) < 1)))
												)
													for (
														jg = q[(a + 244) >> 2],
														...
														for (
															eg = ((bf = cf << 2) + ng) | 0, pg = q[(bf + og) >> 2], df = bf = 0;
															(u[(jg + (kg = df << 2)) >> 2] = u[(pg + kg) >> 2] * u[eg >> 2]),
																(0 | (df = (df + 1) | 0)) < (0 | ag);
								...
								(n[6] = function(a) {
									...
									if (
										...
										for (
											Gg = q[(a + 104) >> 2], Hg = q[(a + 88) >> 2], Dg = q[(a + 96) >> 2];
											(u[((Fg = Cg << 2) + Gg) >> 2] = u[(Dg + Fg) >> 2] * u[(Hg + Fg) >> 2]),
												(0 | Eg) != (0 | (Cg = (Cg + 1) | 0));
											...
											if (q[Kg >> 2]) {
												...
												if (
													...
													for (
														...
														for (
															Jg = ((Cg = Eg << 2) + Sg) | 0, Ug = q[(Cg + Tg) >> 2], Dg = Cg = 0;
															(u[((Og = Dg << 2) + Ng) >> 2] = u[(Ug + Og) >> 2] * u[Jg >> 2]),
																(0 | (Dg = (Dg + 1) | 0)) < (0 | Hg);
								...
								(n[7] = function(a) {
									...
									if (
										...
										for (
											ah = q[(a + 32) >> 2], bh = q[(a + 20) >> 2], Xg = q[(a + 28) >> 2];
											(u[((Zg = Vg << 2) + ah) >> 2] = u[(Xg + Zg) >> 2] * u[(Zg + bh) >> 2]),
												(0 | Yg) != (0 | (Vg = (Vg + 1) | 0));
									...
									if (1 <= (0 | ch))
										for (Zg = q[(a + 12) >> 2], Xg = 0; ; ) {
											if (q[$g >> 2]) {
												if ((0 | (Vg = q[((Yg = _g << 2) + q[(a + 16) >> 2]) >> 2])) < 1) Wg = x(0)
												else
													for (
														ah = (Vg + Xg) | 0, bh = q[(a + 32) >> 2], Wg = x(0), Vg = Xg;
														(Wg = x(Wg + u[(bh + (Vg << 2)) >> 2])),
															(0 | (Vg = (Vg + 1) | 0)) < (0 | ah);
								...
								(n[8] = function(a) {
									...
									if (
										...
										for (
											wg = q[(a + 148) >> 2], tg = q[(a + 120) >> 2], ug = q[(a + 128) >> 2];
											(u[((rg = qg << 2) + wg) >> 2] = u[(rg + ug) >> 2] * u[(rg + tg) >> 2]),
												(0 | vg) != (0 | (qg = (qg + 1) | 0));
											...
											if (q[Ag >> 2]) {
												b: {
													c: {
														d: {
															e: {
																if ((0 | (rg = q[(q[(a + 116) >> 2] + (xg << 2)) >> 2])) <= 0)
																	q[(4 + (((xg << 5) + yg) | 0)) >> 2] = 0
																else {
																	for (
																		zg = (rg + ug) | 0, tg = q[(a + 148) >> 2], sg = x(0), qg = ug;
																		(sg = x(sg + u[(tg + (qg << 2)) >> 2])),
																			(0 | (qg = (qg + 1) | 0)) < (0 | zg);

																	);
																	if (
																		((u[(4 + (vg = ((xg << 5) + yg) | 0)) >> 2] = sg),
																		!(rg = (0 | rg) < 1))
																	) {
																		for (
																			tg = q[(a + 152) >> 2], sg = x(0), qg = ug;
																			(sg = x(sg + u[(tg + (qg << 2)) >> 2])),
																				(0 | (qg = (qg + 1) | 0)) < (0 | zg);
								...
								(n[9] = function(a) {
									...
									var ae,
										...
										be = 0,
										ce = 0
									if (((ae = q[(a + 340) >> 2]), 1 <= (0 | (Wd = q[(a + 360) >> 2]))))
										for (
											_d = q[(a + 368) >> 2], $d = q[(a + 356) >> 2], Vd = q[(a + 364) >> 2];
											(u[((Xd = Ud << 2) + _d) >> 2] = u[(Vd + Xd) >> 2] * u[(Xd + $d) >> 2]),
												(0 | Wd) != (0 | (Ud = (Ud + 1) | 0));
									...
									if (1 <= (0 | ae))
										for (
											...
											if ((0 | (Ud = q[((Wd = Yd << 2) + Xd) >> 2])) < 1) Zd = x(0)
											else
												for (
													_d = (Ud + Vd) | 0, $d = q[(a + 368) >> 2], Zd = x(0), Ud = Vd;
													(Zd = x(Zd + u[($d + (Ud << 2)) >> 2])),
														(0 | (Ud = (Ud + 1) | 0)) < (0 | _d);
								...
								(n[10] = function(a) {
									var ud = 0,
										...
										zd = 0,
										Ad = 0
									if (!(q[(380 + (a |= 0)) >> 2] || (0 | (ud = q[(a + 200) >> 2])) < 1))
										for (
											...
											if (q[ud >> 2] && ((a = 1), !((0 | (wd = q[(vd + 12) >> 2])) < 1)))
												for (
													wd <<= 1, Ad = q[xd >> 2];
								...
								(n[11] = function(a, Fc, nd) {
									...
									return (
										fa(
											(pd = q[(20 + (a |= 0)) >> 2]),
											Fc,
											(od = nd >>> 0 < (od = (q[(a + 16) >> 2] - pd) | 0) >>> 0 ? nd : od)
										),
								...
								(n[13] = function(a, Fc, gd) {
									...
									for (
										...
										a: {
											if (
												((jd = (hd = 0) | K(q[(a + 60) >> 2], 0 | Fc, 0 | ld, (12 + id) | 0)) &&
													((q[1906] = jd), (hd = -1)),
												(0 | (hd = hd ? (q[(12 + id) >> 2] = -1) : q[(12 + id) >> 2])) != (0 | kd))
											) {
												if (-1 < (0 | hd)) break a
												;(q[(a + 28) >> 2] = 0),
													(q[(a + 16) >> 2] = 0),
										...
										;(jd = (hd - ((md = (jd = q[(Fc + 4) >> 2]) >>> 0 < hd >>> 0) ? jd : 0)) | 0),
								...
								(n[15] = function(a, Ub, Fc, Gc, Hc, Ic) {
									...
									if (
										...
										? dd
										: ed)
											? (h(+(Ub = -Ub)), (Jc = 0 | e(1)), e(0), (Yc = 1), 3184)
											: 2048 & Hc
											? ((Yc = 1), 3187)
											: (Yc = 1 & Hc)
											? 3190
										...
										if (
											...
											if ((0 | Mc) < 1) (Jc = Lc), (Kc = Tc)
												...
												for (Kc = Tc; ; ) {
														...
														for (
															...
															(Qc = 0),
																...
																(Oc =
																	32 <= (63 & Gc) >>> 0
																		? ((Mc = Rc << Oc), 0)
																		: ((Mc = ((1 << Oc) - 1) & (Rc >>> (32 - Oc))), Rc << Oc)),
																(Qc = (Mc + Qc) | 0),
																(Qc = (Rc = ($c + Oc) | 0) >>> 0 < Oc >>> 0 ? (Qc + 1) | 0 : Qc),
																($c = Sc),
																(Sc = gc((Rc = hc((Oc = Rc), Qc, 1e9)), M, 1e9)),
																(q[$c >> 2] = Oc - Sc),
																Kc >>> 0 <= (Jc = (Jc + -4) | 0) >>> 0;
													...
													for (; Kc >>> 0 < (Jc = Lc) >>> 0 && !q[(Lc = (Jc + -4) | 0) >> 2]; );
													if (
														((Mc = (q[(44 + Nc) >> 2] - Uc) | 0),
														(Lc = Jc),
														!(0 < (0 | (q[(44 + Nc) >> 2] = Mc))))
											...
											if ((0 | Mc) <= -1)
												for (Xc = (1 + ((((Pc + 25) | 0) / 9) | 0)) | 0, Uc = 102 == (0 | _c); ; ) {
													if (((Rc = (0 | Mc) < -9 ? 9 : (0 - Mc) | 0), Jc >>> 0 <= Kc >>> 0))
														Kc = q[Kc >> 2] ? Kc : (Kc + 4) | 0
													else {
														for (
															Sc = 1e9 >>> Rc, Oc = (-1 << Rc) ^ -1, Mc = 0, Lc = Kc;
															(Gc = q[Lc >> 2]),
																(q[Lc >> 2] = (Gc >>> Rc) + Mc),
																(Mc = w(Sc, Gc & Oc)),
																(Lc = (Lc + 4) | 0) >>> 0 < Jc >>> 0;
											...
											if (
												!(
													Jc >>> (Lc = 0) <= Kc >>> 0 ||
													((Lc = w((Tc - Kc) >> 2, 9)), (Mc = 10), (Gc = q[Kc >> 2]) >>> 0 < 10)
												)
											)
												for (; (Lc = (Lc + 1) | 0), (Mc = w(Mc, 10)) >>> 0 <= Gc >>> 0; );
											if (
												(0 |
													(Gc =
														(((Pc - (102 == (0 | _c) ? 0 : Lc)) | 0) -
												...
												if (
													((Qc =
														(((Tc + ((Oc = ((0 | (Sc = (Gc + 9216) | 0)) / 9) | 0) << 2)) | 0) -
															4092) |
														0),
													(Gc = 10),
													(0 | (Mc = (Sc - w(Oc, 9)) | 0)) <= 7)
												)
													for (; (Gc = w(Gc, 10)), (Oc = (0 | Mc) < 7), (Mc = (Mc + 1) | 0), Oc; );
												if (
													((Xc = (Qc + 4) | 0),
													((Rc =
														((Uc = q[Qc >> 2]) - w(Gc, (Sc = ((Uc >>> 0) / (Gc >>> 0)) | 0))) |
														0) ||
														(0 | Xc) != (0 | Jc)) &&
														((Wc =
															Rc >>> 0 < (Oc = Gc >>> 1) >>> 0
													...
													if (((Gc = (Gc + Oc) | 0), 1e9 <= (q[Qc >> 2] = Gc) >>> 0))
														for (
															;
															(Qc = (Qc + -4) | (q[Qc >> 2] = 0)) >>> 0 < Kc >>> 0 &&
																(q[(Kc = (Kc + -4) | 0) >> 2] = 0),
																(Gc = (q[Qc >> 2] + 1) | 0),
											...
											if (103 == (0 | _c)) {
												if (
													...
													if (
														((Jc = 9),
														Sc && (Oc = q[(Uc + -4) >> 2]) && !((Oc >>> (Jc = 0)) % (Gc = 10)))
													)
														for (; (Jc = (Jc + 1) | 0), !((Oc >>> 0) % ((Gc = w(Gc, 10)) >>> 0)); );
													;(Gc = (w((Uc - Tc) >> 2, 9) + -9) | 0),
														(Pc =
															102 != (32 | Ic)
																? ((Oc = 0) | Pc) <
																  (0 | (Gc = 0 < (0 | (Gc = (((Gc + Lc) | 0) - Jc) | 0)) ? Gc : 0))
																	? Pc
																	: Gc
																: ((Oc = 0) | Pc) <
																  (0 | (Gc = 0 < (0 | (Gc = (Gc - Jc) | 0)) ? Gc : 0))
																? Pc
																: Gc)
												}
											} else Oc = 8 & Hc
											if (
												...
												if (((Vc - (Jc = ea(((Jc = Lc >> 31) + Lc) ^ Jc, 0, Vc))) | 0) <= 1)
													for (; (o[0 | (Jc = (Jc + -1) | 0)] = 48), ((Vc - Jc) | 0) < 2; );
												;(o[0 | (Xc = (Jc + -2) | 0)] = Ic),
													(o[(Jc + -1) | 0] = (0 | Lc) < 0 ? 45 : 43),
													(Jc = (Vc - Xc) | 0)
											}
											_(Gc, 32, $c, (Qc = (1 + ((Jc + ((Qc + ((Pc + Yc) | 0)) | 0)) | 0)) | 0), Hc),
												Z(a, Zc, Yc),
													...
													p: {
														if (102 == (0 | Rc)) {
															for (
																...
																Jc = ea(q[Kc >> 2], 0, Lc)
																q: if ((0 | Ic) == (0 | Kc))
																	(0 | Jc) == (0 | Lc) && ((o[(24 + Nc) | 0] = 48), (Jc = Gc))
																else {
																	if (Jc >>> 0 <= (16 + Nc) >>> 0) break q
																	for (
																		;
																		(o[0 | (Jc = (Jc + -1) | 0)] = 48), (16 + Nc) >>> 0 < Jc >>> 0;
															...
															if ((Mc && Z(a, 3219, 1), ((0 | Pc) < 1) | (Uc >>> 0 <= Kc >>> 0)))
																break p
															for (;;) {
																if ((16 + Nc) >>> 0 < (Jc = ea(q[Kc >> 2], 0, Lc)) >>> 0)
																	for (
																		;
																		(o[0 | (Jc = (Jc + -1) | 0)] = 48), (16 + Nc) >>> 0 < Jc >>> 0;
														...
														r: if (!((0 | Pc) < 0))
															for (
																...
																if (
																	(Z(a, (Rc = Jc), (0 | (Jc = (Tc - Jc) | 0)) < (0 | Pc) ? Jc : Pc),
																	(Pc = (Pc - Jc) | 0),
																	Ic >>> 0 <= (Lc = (Lc + 4) | 0) >>> 0)
																)
																	break r
														...
														_(a, 48, (Pc + 18) | 0, 18, 0), Z(a, Xc, (Vc - Xc) | 0)
														break n
													}
													Jc = Pc
												}
											...
											if (
												((Oc = (Tc = 32 & Ic) ? (Zc + 9) | 0 : Zc),
												!(11 < Gc >>> 0) && (Jc = (12 - Gc) | 0))
											) {
												for (Wc = 8; (Wc *= 16), (Jc = (Jc + -1) | 0); );
												Ub = 45 != r[0 | Oc] ? Ub + Wc - Wc : -(Wc + (-Ub - Wc))
											}
											for (
												(0 | Vc) ==
													(0 |
														(Jc = ea((Lc = (Jc = q[(44 + Nc) >> 2]) >> 31) ^ (Jc + Lc), 0, Vc))) &&
											...
											_(
												...
												_(a, 48, (Ic - (((Jc = Gc) + (Gc = (Vc - Sc) | 0)) | 0)) | 0, 0, 0),
												Z(a, Sc, Gc)
										}
									else
								...
								(n[16] = function(a, Ub) {
									...
									;(a |= 0),
										...
										(q[uc >> 2] = Ub + 16),
										(Dc = a),
										(Ec = Ea(q[Ub >> 2], q[(Ub + 4) >> 2], q[(Ub + 8) >> 2], q[(Ub + 12) >> 2])),
										(v[Dc >> 3] = Ec)
								}),
								{
										...
										return (
											...
											(a = (a |= 0)
												? ma(a)
													? (Y(4, 1533, 0), 0)
													: r[(a + 4) | 0]
												: ((q[(Ub + 4) >> 2] = 1246), (q[Ub >> 2] = 1671), Y(4, 1087, Ub), 0)),
											(L = (Ub + 16) | 0),
											0 | a
										)
									},
											...
											(a = (a |= 0)
												? ((a + 63) & -64) == (0 | a)
													...
													: ((q[(36 + ri) >> 2] = 1441),
													  ...
													  Y(4, 1087, (32 + ri) | 0),
													  0)
												: ((q[(4 + ri) >> 2] = 1246), (q[ri >> 2] = 1688), Y(4, 1087, ri), 0)),
											(L = (48 + ri) | 0),
											0 | a
										)
									},
											...
											(a |= 0)
												? _h
													...
													: ((q[(20 + bi) >> 2] = 1726),
													  (q[(16 + bi) >> 2] = 1708),
													  Y(4, 1087, (16 + bi) | 0))
												: ((q[(4 + bi) >> 2] = 1651), (q[bi >> 2] = 1708), Y(4, 1087, bi)),
											(L = (64 + bi) | 0)
									},
									...
									csmUpdateModel: function(a) {
										...
										;(L = Zh = (L - 16) | 0),
											(a |= 0)
												? ta(a)
												: ((q[(4 + Zh) >> 2] = 1651), (q[Zh >> 2] = 1890), Y(4, 1087, Zh)),
											(L = (16 + Zh) | 0)
									},
									csmGetParameterCount: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 292) >> 2]
												: ((q[(4 + Yh) >> 2] = 1651), (q[Yh >> 2] = 1905), Y(4, 1087, Yh), -1)),
											(L = (16 + Yh) | 0),
											0 | a
										)
									},
									csmGetParameterIds: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 900) >> 2]
												: ((q[(4 + Xh) >> 2] = 1651), (q[Xh >> 2] = 1926), Y(4, 1087, Xh), 0)),
											(L = (16 + Xh) | 0),
											0 | a
										)
									},
									csmGetParameterMinimumValues: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 912) >> 2]
												: ((q[(4 + Wh) >> 2] = 1651), (q[Wh >> 2] = 1945), Y(4, 1087, Wh), 0)),
											(L = (16 + Wh) | 0),
											0 | a
										)
									},
									csmGetParameterMaximumValues: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 908) >> 2]
												: ((q[(4 + Vh) >> 2] = 1651), (q[Vh >> 2] = 1974), Y(4, 1087, Vh), 0)),
											(L = (16 + Vh) | 0),
											0 | a
										)
									},
									csmGetParameterDefaultValues: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 916) >> 2]
												: ((q[(4 + Uh) >> 2] = 1651), (q[Uh >> 2] = 2003), Y(4, 1087, Uh), 0)),
											(L = (16 + Uh) | 0),
											0 | a
										)
									},
									csmGetParameterValues: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 300) >> 2]
												: ((q[(4 + Sh) >> 2] = 1651), (q[Sh >> 2] = 2032), Y(4, 1087, Sh), 0)),
											(L = (16 + Sh) | 0),
											0 | a
										)
									},
									csmGetPartCount: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 4) >> 2]
												: ((q[(4 + Rh) >> 2] = 1651), (q[Rh >> 2] = 2054), Y(4, 1087, Rh), -1)),
											(L = (16 + Rh) | 0),
											0 | a
										)
									},
									csmGetPartIds: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 712) >> 2]
												: ((q[(4 + Qh) >> 2] = 1651), (q[Qh >> 2] = 2070), Y(4, 1087, Qh), 0)),
											(L = (16 + Qh) | 0),
											0 | a
										)
									},
									csmGetPartOpacities: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 52) >> 2]
												: ((q[(4 + Ph) >> 2] = 1651), (q[Ph >> 2] = 2084), Y(4, 1087, Ph), 0)),
											(L = (16 + Ph) | 0),
											0 | a
										)
									},
									csmGetPartParentPartIndices: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 740) >> 2]
												: ((q[(4 + Oh) >> 2] = 1651), (q[Oh >> 2] = 2104), Y(4, 1087, Oh), 0)),
											(L = (16 + Oh) | 0),
											0 | a
										)
									},
									csmGetDrawableCount: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 200) >> 2]
												: ((q[(4 + Nh) >> 2] = 1651), (q[Nh >> 2] = 2132), Y(4, 1087, Nh), -1)),
											(L = (16 + Nh) | 0),
											0 | a
										)
									},
									csmGetDrawableIds: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 820) >> 2]
												: ((q[(4 + Mh) >> 2] = 1651), (q[Mh >> 2] = 2152), Y(4, 1087, Mh), 0)),
											(L = (16 + Mh) | 0),
											0 | a
										)
									},
									csmGetDrawableConstantFlags: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 872) >> 2]
												: ((q[(4 + Lh) >> 2] = 1651), (q[Lh >> 2] = 2170), Y(4, 1087, Lh), 0)),
											(L = (16 + Lh) | 0),
											0 | a
										)
									},
									csmGetDrawableDynamicFlags: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 260) >> 2]
												: ((q[(4 + Kh) >> 2] = 1651), (q[Kh >> 2] = 2198), Y(4, 1087, Kh), 0)),
											(L = (16 + Kh) | 0),
											0 | a
										)
									},
									csmGetDrawableTextureIndices: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 868) >> 2]
												: ((q[(4 + Jh) >> 2] = 1651), (q[Jh >> 2] = 2225), Y(4, 1087, Jh), 0)),
											(L = (16 + Jh) | 0),
											0 | a
										)
									},
									csmGetDrawableDrawOrders: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 268) >> 2]
												: ((q[(4 + Ih) >> 2] = 1651), (q[Ih >> 2] = 2254), Y(4, 1087, Ih), 0)),
											(L = (16 + Ih) | 0),
											0 | a
										)
									},
									csmGetDrawableRenderOrders: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 264) >> 2]
												: ((q[(4 + Hh) >> 2] = 1651), (q[Hh >> 2] = 2279), Y(4, 1087, Hh), 0)),
											(L = (16 + Hh) | 0),
											0 | a
										)
									},
									csmGetDrawableOpacities: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 276) >> 2]
												: ((q[(4 + Gh) >> 2] = 1651), (q[Gh >> 2] = 2306), Y(4, 1087, Gh), 0)),
											(L = (16 + Gh) | 0),
											0 | a
										)
									},
									csmGetDrawableMaskCounts: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 896) >> 2]
												: ((q[(4 + Fh) >> 2] = 1651), (q[Fh >> 2] = 2330), Y(4, 1087, Fh), 0)),
											(L = (16 + Fh) | 0),
											0 | a
										)
									},
									csmGetDrawableMasks: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 832) >> 2]
												: ((q[(4 + Eh) >> 2] = 1651), (q[Eh >> 2] = 2355), Y(4, 1087, Eh), 0)),
											(L = (16 + Eh) | 0),
											0 | a
										)
									},
									csmGetDrawableVertexCounts: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 876) >> 2]
												: ((q[(4 + Dh) >> 2] = 1651), (q[Dh >> 2] = 2375), Y(4, 1087, Dh), 0)),
											(L = (16 + Dh) | 0),
											0 | a
										)
									},
									csmGetDrawableVertexPositions: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(a + 272) >> 2]
												: ((q[(4 + Ch) >> 2] = 1651), (q[Ch >> 2] = 2402), Y(4, 1087, Ch), 0)),
											(L = (16 + Ch) | 0),
											0 | a
										)
									},
									csmGetDrawableVertexUvs: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 824) >> 2]
												: ((q[(4 + Bh) >> 2] = 1651), (q[Bh >> 2] = 2432), Y(4, 1087, Bh), 0)),
											(L = (16 + Bh) | 0),
											0 | a
										)
									},
									csmGetDrawableIndexCounts: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 888) >> 2]
												: ((q[(4 + gh) >> 2] = 1651), (q[gh >> 2] = 2456), Y(4, 1087, gh), 0)),
											(L = (16 + gh) | 0),
											0 | a
										)
									},
									csmGetDrawableIndices: function(a) {
										...
										return (
											...
											(a = (a |= 0)
												? q[(q[a >> 2] + 828) >> 2]
												: ((q[(4 + fh) >> 2] = 1651), (q[fh >> 2] = 2482), Y(4, 1087, fh), 0)),
											(L = (16 + fh) | 0),
											0 | a
										)
									},
									csmResetDrawableDynamicFlags: function(a) {
										...
										;(L = dh = (L - 16) | 0),
											(a |= 0)
												? (q[(a + 256) >> 2] = 1)
												: ((q[(4 + dh) >> 2] = 1651), (q[dh >> 2] = 2504), Y(4, 1087, dh)),
											(L = (16 + dh) | 0)
									},
							...
							function Y(a, b, c) {
								...
								;(L = g = (L - 272) | 0),
									t[1640] > a >>> 0 ||
										((a = q[1641]) &&
											(sa((16 + g) | 0, b, (q[(12 + g) >> 2] = c)), n[a]((16 + g) | 0))),
									(L = (272 + g) | 0)
							}
							function Z(a, b, c) {
								32 & r[0 | a] ||
									(function(a, Ub, Fc) {
										...
										a: {
											...
											b: if (!(o[(Fc + 75) | 0] < 0)) {
												...
												if (n[q[(Fc + 36) >> 2]](Fc, a, Hc) >>> 0 < Hc >>> 0) break a
												;(Ub = (Ub - Hc) | 0), (a = (a + Hc) | 0), (Ic = q[(Fc + 20) >> 2])
											}
											fa(Ic, a, Ub), (q[(Fc + 20) >> 2] = q[(Fc + 20) >> 2] + Ub)
										}
									})(b, c, a)
							}
							function _(a, b, c, h, i) {
								...
								if (((L = j = (L - 256) | 0), !((73728 & i) | ((0 | c) <= (0 | h))))) {
									if (
										(ba(j, b, (k = (i = (c - h) | 0) >>> 0 < 256) ? i : 256), (b = a), (l = j), !k)
									) {
							...
							function fa(a, t, w) {
								...
								if (8192 <= w >>> 0) I(0 | a, 0 | t, 0 | w)
									...
									a: if (3 & (a ^ t))
										...
										for (
											;
											(q[w >> 2] = q[t >> 2]), (t = (t + 4) | 0), (w = (w + 4) | 0) >>> 0 < a >>> 0;
									...
									if (w >>> 0 < y >>> 0)
										for (
											;
											(o[0 | w] = r[0 | t]), (t = (t + 1) | 0), (0 | y) != (0 | (w = (w + 1) | 0));
							...
							function ha(a, o) {
								a: if (1024 <= (0 | o)) {
									...
									;(a *= 898846567431158e293), (o = (((0 | o) < 3069 ? o : 3069) + -2046) | 0)
								} else
									-1023 < (0 | o) ||
							...
							function ia(a, t, A, B, C, D, E) {
								...
								a: {
									b: for (;;) {
										;(0 | P) < 0 ||
											(P = ((2147483647 - P) | 0) < (0 | t) ? ((q[1906] = 61), -1) : (t + P) | 0)
										d: {
											e: {
												f: {
													g: {
														h: {
															i: {
																j: {
																	k: {
																					...
																					o: {
																						p: {
																							q: {
																								...
																								if (((O = 1), 10 <= t >>> 0)) break a
																								for (;;) {
																									if (q[((t << 2) + C) >> 2]) break q
																									if (((a = 8 < t >>> 0), (t = (t + 1) | 0), a))
																										break
																								}
																								break a
																							}
																						...
																						t = 0 | n[D](a, v[(64 + F) >> 3], N, H, I, t)
																						continue
																					}
																					;(G =
																						(t = Ia((J = (t = q[(64 + F) >> 2]) || 2694), H)) ||
																						(H + J) | 0),
																						(I = K),
																						(H = t ? (t - J) | 0 : H)
																					break e
																		...
																		if (((J = Oa(q[(64 + F) >> 2], q[(68 + F) >> 2], R)), !(8 & I)))
																			break f
																		H = (0 | (t = (R - J) | 0)) < (0 | H) ? H : (t + 1) | 0
																		break f
																	}
																	;(H = 8 < H >>> 0 ? H : 8), (I |= 8), (t = 120)
																}
																if (
																	((J = Na(q[(64 + F) >> 2], q[(68 + F) >> 2], R, 32 & t)),
																	!(8 & I) | !(q[(64 + F) >> 2] | q[(68 + F) >> 2]))
																)
																	break f
																;(Q = (2684 + (t >>> 4)) | 0), (O = 2)
																break f
															...
															;(G = q[(64 + F) >> 2]), (q[G >> 2] = P), (q[(G + 4) >> 2] = P >> 31)
															continue
														}
														;(J = q[(64 + F) >> 2]), (t = q[(68 + F) >> 2]), (Q = 2684)
													}
													J = ea(J, t, R)
												}
												;(I = -1 < (0 | H) ? -65537 & I : I),
													(H =
														!!((K = t = q[(68 + F) >> 2]) | (M = q[(64 + F) >> 2])) | H
															? (0 | (t = (!(K | M) + ((R - J) | 0)) | 0)) < (0 | H)
																? H
																: t
															: ((J = R), 0))
								...
								a: {
									b: {
										c: {
											d: {
												e: {
																			...
																			if (a >>> 0 <= 244) {
																				if (
																					...
																					;(a =
																						...
																						(0 | (A = q[(o + 8) >> 2])) !=
																						(0 | (B = (B + 7732) | 0))
																							? ((q[(A + 12) >> 2] = B), (q[(B + 8) >> 2] = A))
																							: ((Z = 7692), (_ = jc(w) & C), (q[Z >> 2] = _)),
																						(w <<= 3),
																						(q[(o + 4) >> 2] = 3 | w),
																						(q[((o = (o + w) | 0) + 4) >> 2] = 1 | q[(o + 4) >> 2])
																					break a
																				}
																				if (D >>> 0 <= (V = q[1925]) >>> 0) break k
																				if (o) {
																					;(w = o =
																						((a =
																							(((0 - (a = ((0 - (w = 2 << a)) | w) & (o << a))) &
																				...
																				for (
																					w = o = ((a = ((X & (0 - X)) - 1) | 0) >>> 12) & 16,
																						...
																						A = ((-8 & q[(o + 4) >> 2]) - D) | 0,
																						w = o;
																					(a = (a = q[(w + 16) >> 2]) || q[(w + 20) >> 2]);

																				)
																					(A = (w =
																						(B = ((-8 & q[(a + 4) >> 2]) - D) | 0) >>> 0 < A >>> 0)
																						? B
																						: A),
																						(o = w ? a : o),
																						(w = a)
																		...
																		v: {
																			w: {
																				...
																				if (
																					...
																					(A = ((a = q[2042]) + -1) | 0) & o &&
																						(C = (((w - o) | 0) + ((o + A) & (0 - a))) | 0),
																					(C >>> 0 <= D >>> 0) | (2147483646 < C >>> 0))
																				)
																					break g
																				if (
																					(a = q[2033]) &&
																					((E = ((A = q[2031]) + C) | 0) >>> 0 <= A >>> 0) |
																						(a >>> 0 < E >>> 0)
																				)
																					break g
																				if ((0 | o) != (0 | (a = da(C)))) break v
																				break e
																			}
																			if (2147483646 < (C = E & (C - A)) >>> 0) break g
																			if ((0 | (o = da(C))) == ((q[a >> 2] + q[(a + 4) >> 2]) | 0))
																				break h
																			a = o
																		}
																		if (
													...
													if (
														((o = da(w)),
														((a = da(0)) >>> 0 <= o >>> 0) | (-1 == (0 | o)) | (-1 == (0 | a)))
													)
														break d
													if ((C = (a - o) | 0) >>> 0 <= (D + 40) >>> 0) break d
												}
												;(a = (q[2031] + C) | 0), (q[2031] = a) >>> 0 > t[2032] && (q[2032] = a)
												x: {
													y: {
														z: {
															if ((w = q[1929])) {
																for (a = 8140; ; ) {
																	if ((((A = q[a >> 2]) + (B = q[(a + 4) >> 2])) | 0) == (0 | o))
																		break z
																	if (!(a = q[(a + 8) >> 2])) break
																}
																break y
														...
														if (
															!((8 & r[(a + 12) | 0]) | (o >>> 0 <= w >>> 0) | (w >>> 0 < A >>> 0))
														) {
															;(q[(a + 4) >> 2] = B + C),
																(o = ((a = (w + 8) & 7 ? (-8 - w) & 7 : 0) + w) | 0),
																(q[1929] = o),
																(a = ((A = (q[1926] + C) | 0) - a) | 0),
																(q[1926] = a),
																(q[(o + 4) >> 2] = 1 | a),
															...
															C: {
																D: {
																	...
																	if (
																		...
																		(q[(a + 4) >> 2] = q[(a + 4) >> 2] + C),
																		(q[
																			((W = (((o + 8) & 7 ? (-8 - o) & 7 : 0) + o) | 0) + 4) >> 2
																		] = 3 | D),
																		(a =
																			((((o = (A + ((A + 8) & 7 ? (-8 - A) & 7 : 0)) | 0) - W) |
																				0) -
																				D) |
																			0),
																		(E = (D + W) | 0),
																	...
																	if (1 == (3 & (w = q[(o + 4) >> 2]))) {
																		...
																		G: if (w >>> 0 <= 255) {
																			if (
																				...
																				;(Z = 7692), (_ = q[1923] & jc(B)), (q[Z >> 2] = _)
																				break G
																			}
																			;(q[(w + 12) >> 2] = A), (q[(A + 8) >> 2] = w)
																		} else {
																			if (
																				((V = q[(o + 24) >> 2]),
																				(0 | (C = q[(o + 12) >> 2])) == (0 | o))
																			...
																			if (V) {
																				w = q[(o + 28) >> 2]
																				J: {
																					if (q[(A = (7996 + (w << 2)) | 0) >> 2] == (0 | o)) {
																						if ((q[A >> 2] = C)) break J
																						;(Z = 7696), (_ = q[1924] & jc(w)), (q[Z >> 2] = _)
																						break G
																					}
																					if (
																						!(q[
																							(V + (q[(V + 16) >> 2] == (0 | o) ? 16 : 20)) >> 2
																						] = C)
																					)
																						break G
																				}
																				;(q[(C + 24) >> 2] = V),
																					(w = q[(o + 16) >> 2]) &&
																						((q[(C + 16) >> 2] = w), (q[(w + 24) >> 2] = C)),
																					(w = q[(o + 20) >> 2]) &&
																						((q[(C + 20) >> 2] = w), (q[(w + 24) >> 2] = C))
																			}
																		}
																		;(o = (o + X) | 0), (a = (a + X) | 0)
																	}
																	...
																	if (
																		...
																		(q[((w = E) + 28) >> 2] = o),
																		(q[(E + 16) >> 2] = 0),
																		(w = (7996 + (o << 2)) | (q[(E + 20) >> 2] = 0)),
																		(A = q[1924]) & (B = 1 << o))
																	) {
																		for (
																			A = a << (31 == (0 | o) ? 0 : (25 - (o >>> 1)) | 0),
																				o = q[w >> 2];
																			;

																		) {
																			if ((-8 & q[((w = o) + 4) >> 2]) == (0 | a)) break C
																			if (
																				((o = A >>> 29),
																				(A <<= 1),
																				!(o = q[((B = ((4 & o) + w) | 0) + 16) >> 2]))
																...
																if (
																			...
																			(a =
																				(28 +
																					(((a =
																						...
																						((B >>> (a + 21)) & 1))) |
																				0)),
																	(o = (7996 + ((q[((o = w) + 28) >> 2] = a) << 2)) | 0),
																	(A = q[1924]) & (C = 1 << a))
																) {
																	for (
																		a = B << (31 == (0 | a) ? 0 : (25 - (a >>> 1)) | 0),
																			o = q[o >> 2];
																		;

																	) {
																		if ((0 | B) == (-8 & q[((A = o) + 4) >> 2])) break A
																		if (
																			((o = a >>> 29),
																			(a <<= 1),
																			!(o = q[((C = (A + (4 & o)) | 0) + 16) >> 2]))
																	...
																	;(q[(C + 16) >> 2] = w), (q[(w + 24) >> 2] = A)
																} else (q[1924] = A | C), (q[o >> 2] = w), (q[(w + 24) >> 2] = o)
										...
										Q: if (E) {
											...
											R: {
												...
												if (!(q[(E + (q[(E + 16) >> 2] == (0 | B) ? 16 : 20)) >> 2] = o)) break Q
											}
											;(q[(o + 24) >> 2] = E),
												(a = q[(B + 16) >> 2]) && ((q[(o + 16) >> 2] = a), (q[(a + 24) >> 2] = o)),
												(a = q[(B + 20) >> 2]) && ((q[(o + 20) >> 2] = a), (q[(a + 24) >> 2] = o))
										}
										S: if (w >>> 0 <= 15)
											(a = (w + D) | 0),
												(q[(B + 4) >> 2] = 3 | a),
												(q[((a = (a + B) | 0) + 4) >> 2] = 1 | q[(a + 4) >> 2])
										else if (
											((q[(B + 4) >> 2] = 3 | D),
											(q[((A = (B + D) | 0) + 4) >> 2] = 1 | w),
											(q[(w + A) >> 2] = w) >>> 0 <= 255)
											...
											(a = (7732 + ((o = w >>> 3) << 3)) | 0),
												(o =
													(w = q[1923]) & (o = 1 << o) ? q[(a + 8) >> 2] : ((q[1923] = o | w), a)),
												(q[(a + 8) >> 2] = A),
												(q[(o + 12) >> 2] = A),
												(q[(A + 12) >> 2] = a),
												(q[(A + 8) >> 2] = o)
											...
											V: {
												if ((D = 1 << a) & V) {
													for (
														a = w << (31 == (0 | a) ? 0 : (25 - (a >>> 1)) | 0), D = q[o >> 2];
														;

													) {
														if ((-8 & q[((o = D) + 4) >> 2]) == (0 | w)) break V
														if (
															((D = a >>> 29),
															(a <<= 1),
															!(D = q[((C = ((4 & D) + o) | 0) + 16) >> 2]))
												...
												;(q[(A + 24) >> 2] = o), (q[(A + 12) >> 2] = A), (q[(A + 8) >> 2] = A)
												break S
											}
											;(a = q[(o + 8) >> 2]),
												(q[(a + 12) >> 2] = A),
									...
									X: if (W) {
										...
										Y: {
											...
											if (!(q[(W + (q[(W + 16) >> 2] == (0 | o) ? 16 : 20)) >> 2] = B)) break X
										}
										;(q[(B + 24) >> 2] = W),
											(a = q[(o + 16) >> 2]) && ((q[(B + 16) >> 2] = a), (q[(a + 24) >> 2] = B)),
											(a = q[(o + 20) >> 2]) && ((q[(B + 20) >> 2] = a), (q[(a + 24) >> 2] = B))
									}
									A >>> 0 <= 15
										? ((a = (A + D) | 0),
										  (q[(o + 4) >> 2] = 3 | a),
										  (q[((a = (a + o) | 0) + 4) >> 2] = 1 | q[(a + 4) >> 2]))
										: ((q[(o + 4) >> 2] = 3 | D),
										  (q[((D = (o + D) | 0) + 4) >> 2] = 1 | A),
										  (q[(A + D) >> 2] = A),
										  V &&
												((a = (7732 + ((w = V >>> 3) << 3)) | 0),
												(B = q[1928]),
												(w = (w = 1 << w) & C ? q[(a + 8) >> 2] : ((q[1923] = w | C), a)),
												(q[(a + 8) >> 2] = B),
												(q[(w + 12) >> 2] = B),
												(q[(B + 12) >> 2] = a),
												(q[(B + 8) >> 2] = w)),
							...
							function ka(a) {
								...
								a: {
									if (1283457024 <= (q = 2147483647 & ($ = e(0))) >>> 0) {
										...
										return x((0 | $) < 0 ? -1.570796251296997 : 1.570796251296997)
									}
									b: {
										if (q >>> 0 <= 1054867455) {
									...
									if (
										...
										(aa = x(a * a)),
										(t = x(aa * aa)),
										(ba = x(t * x(x(t * x(-0.106480173766613)) + x(-0.19999158382415771)))),
										(t = x(
											aa *
												x(
													x(t * x(x(t * x(0.06168760731816292)) + x(0.14253635704517365))) +
														x(0.333333283662796)
												)
										)),
										(0 | q) <= -1)
									...
									;(a = x(
										u[((q <<= 2) + 6080) >> 2] - x(x(x(a * x(ba + t)) - u[(q + 6096) >> 2]) - a)
									)),
										(a = (0 | $) < 0 ? x(-a) : a)
								}
								return a
							...
							function la(a, ca) {
								...
								a: if ((da = 2147483647 & (ga = e(0))) >>> 0 <= 1305022426) {
									if (
										((ea = 0.6366197723675814 * (ha = +a) + 6755399441055744 - 6755399441055744),
										(v[ca >> 3] = ha + -1.5707963109016418 * ea + -1.5893254773528196e-8 * ea),
										y(ea) < 2147483648)
									) {
										da = ~~ea
										break a
							...
							function ma(a) {
								...
								;(ka = 4), (ja = 1082)
								a: if ((ca = r[0 | a])) {
									for (; !((0 | (la = r[0 | ja])) != (0 | ca) || !(ka = (ka + -1) | 0) | !la); )
										if (((ja = (ja + 1) | 0), (ca = r[(a + 1) | 0]), (a = (a + 1) | 0), !ca))
											break a
									ma = ca
								}
											...
											a: {
												if (a) {
													...
													if (q[q[1625] >> 2]) {
														if (Ub >>> 0 <= 2047)
															return (
																(o[(a + 1) | 0] = (63 & Ub) | 128), (o[0 | a] = (Ub >>> 6) | 192), 2
															)
								...
								a: {
									if (!(20 < na >>> 0 || 9 < (na = (na + -9) | 0) >>> 0)) {
										c: switch ((na - 1) | 0) {
											default:
												return (
													(na = q[oa >> 2]), (q[oa >> 2] = na + 4), void (q[a >> 2] = q[na >> 2])
												)
											case 0:
												return (
													(na = q[oa >> 2]),
							...
							function ra(a, ta, ua, va, wa) {
								...
								;(q[(204 + (L = xa = (L - 208) | 0)) >> 2] = ua),
									...
									(0 | ia(0, ta, (200 + xa) | 0, (80 + xa) | 0, (160 + xa) | 0, va, wa)) < 0 ||
										((ua = 0 <= q[(a + 76) >> 2] ? 1 : ua),
										(ya = q[a >> 2]),
										o[(a + 74) | 0] <= 0 && (q[a >> 2] = -33 & ya),
										(za = 32 & ya),
										q[(a + 48) >> 2]
											? ia(a, ta, (200 + xa) | 0, (80 + xa) | 0, (160 + xa) | 0, va, wa)
											: ((q[(a + 48) >> 2] = 80),
											  (q[(a + 16) >> 2] = 80 + xa),
											  (q[(a + 28) >> 2] = xa),
											  (q[(a + 20) >> 2] = xa),
							...
							function sa(a, ta, ua) {
								...
								fa((8 + (L = va = (L - 160) | 0)) | 0, 2536, 144),
									(q[(52 + va) >> 2] = a),
									(wa = (wa = (-2 - (q[(28 + va) >> 2] = a)) | 0) >>> 0 < 256 ? wa : 256),
									(a = (a + (q[(56 + va) >> 2] = wa)) | 0),
									(q[(36 + va) >> 2] = a),
									(q[(24 + va) >> 2] = a),
									ra((8 + va) | 0, ta, ua, 15, 16),
									wa &&
										((a = q[(28 + va) >> 2]), (o[(a - ((0 | a) == q[(24 + va) >> 2])) | 0] = 0)),
									(L = (160 + va) | 0)
							}
							function ta(a) {
								var ta = 0,
									...
									if (!((0 | Ca) < 1))
										for (Oa = q[(a + 308) >> 2], Ma = q[(a + 376) >> 2]; ; ) {
											e: if (!((0 | (ua = q[(Ea + 28) >> 2])) < 1))
												if (
													((Ha = ((ta = (Oa + w(q[(Ea + 24) >> 2], 28)) | 0) + w(ua, 28)) | 0),
													(Ua = u[(Ea + 20) >> 2]),
													(Ta = u[(Ea + 16) >> 2]),
													(Pa = u[(Ea + 32) >> 2]),
													Ma)
																...
																n: {
																	if ((0 | (Da = q[ta >> 2])) < 1) Aa = Ba = 0
																		...
																		if (((Ba = 0), Pa < x(Ta + Na))) Aa = 0
																			...
																			if (((Aa = 1), (Fa = u[(ua + 4) >> 2]), !(Pa < x(Ta + Fa))))
																				for (;;) {
																					if ((0 | Da) == (0 | (Aa = (Aa + 1) | 0))) break n
																					if (
																						((Na = Fa),
																						(Fa = u[(ua + (Aa << 2)) >> 2]),
																						Pa < x(Ta + Fa))
																			...
																			x(Fa - Ta) < Pa ||
																				((Aa = (Aa + -1) | 0),
																				(Fa = x(Fa - Na)) < Ua || (Sa = x(x(Pa - Na) / Fa)))
																		}
																	} else (Ba = ((Pa < x(Ta + Na)) ^ 1) | ((Fa < Pa) ^ 1)), (Aa = 0)
																	if (Ba) break m
																	if (((La = Da = 1), !q[(ta + 16) >> 2])) break m
																	break l
																}
																;(Aa = (Da + -1) | 0), (Ba = 1)
															}
																...
																h: {
																	i: if (!(((Ba = 0) | (Aa = q[(ua = ta) >> 2])) < 1)) {
																		if (
																			...
																			if (!(Pa < Fa)) {
																				if (((Ba = 0), Pa < x(Ta + Na))) break i
																				Da = 1
																				j: if (((Fa = u[(Ja + 4) >> 2]), !(Pa < x(Ta + Fa)))) {
																					for (
																						Aa = (Aa + -1) | 0;
																						(Na = Fa), (0 | Aa) != (0 | Da);
																				...
																				if (((Aa = (Da + -1) | 0), (Fa = x(Fa - Na)) < Ua)) break h
																				Sa = x(x(Pa - Na) / Fa)
																				break h
																			}
																			;(Ba = 1), (Aa = 0)
																		...
																		Ba = ((Pa < x(Ta + Na)) ^ 1) | ((Fa < Pa) ^ 1)
																	}
																	Aa = 0
																}
																if (!Ba && ((Ja = Da = 1), q[(ta + 16) >> 2])) break f
															}
															;(Ca = Ba),
																(Ja =
																	((Da = (Fa = u[(ta + 12) >> 2]) != Sa) &
								...
								if (1 <= (0 | (ta = q[(a + 312) >> 2])))
									for (
										Ja = ((Ia = q[(a + 316) >> 2]) + w(ta, 36)) | 0, Ga = q[(a + 376) >> 2];
										;

									) {
										;(Za = ((ua = q[(Ia + 12) >> 2]) + ((Ea = q[Ia >> 2]) << 2)) | 0),
											(Qa = q[(a + 308) >> 2]),
											(ta = ua)
										p: {
											if (!(Ea = ((Da = Ba = Ca = 0) | Ea) < 1))
												for (;;) {
													if (((Aa = (Qa + w(q[ta >> 2], 28)) | 0), q[(Aa + 16) >> 2])) {
														;(La = 1), (Ra = Ya = 0)
														break p
													}
													if (
											...
											if (
												...
												(Ra = Ga ? 1 : Da) | (Ya = Ga ? 1 : Ca) &&
													((Xa = 1 << Ba), (q[(Ia + 8) >> 2] = Xa), 31 != (0 | Ba)))
											) {
												for (
													Ca = q[(Ia + 20) >> 2],
														Aa = ((ta = q[(Ia + 16) >> 2]) + (Da = Xa << 2)) | 0,
														Va = ba(
															(Ka = ta),
															0,
															(4 +
																(((Ha = -1 ^ ta) +
																	((ta = (ta + 4) | 0) >>> 0 < Aa >>> 0 ? Aa : ta)) |
																	0)) &
																-4
														),
														Da = (Ca + Da) | 0,
														ta = Ca;
													(q[ta >> 2] = 1065353216), (ta = (ta + 4) | 0) >>> 0 < Da >>> 0;
												...
												if (!Ea)
													if (((Da = Ea = 1), Ba))
														for (;;) {
															...
															if (
																((Ea = w(q[Ka >> 2], Ea)), !((ua = (ua + 4) | 0) >>> 0 < Za >>> 0))
															)
																break
														}
													else
														for (;;) {
															if (
																...
																(q[Va >> 2] = Da + q[Va >> 2]),
																	(u[Ca >> 2] = x(x(1) - Fa) * u[Ca >> 2])
															if (
																((Ea = w(q[Aa >> 2], Ea)), !((ua = (ua + 4) | 0) >>> 0 < Za >>> 0))
															)
																break
														}
											}
								...
								if (!((0 | (Ba = q[(a + 4) >> 2])) <= 0)) {
									...
									if (!((0 | Ba) < 1)) {
										...
										if (!((0 | (Ga = q[(a + 4) >> 2])) < 1))
											for (
												Ja = q[a >> 2], Oa = q[(Ja + 724) >> 2], ua = q[(a + 40) >> 2], Da = Ea = 0;
												;
												...
												if (
													((Ka = (Ha + w(q[ua >> 2], 36)) | 0),
													(q[(Ka + 28) >> 2] || q[(Ka + 24) >> 2]) &&
														((q[((Ca = Ea << 2) + q[(a + 16) >> 2]) >> 2] = q[(Ka + 8) >> 2]),
														q[(Ka + 24) >> 2] && !((0 | (Ba = q[(Ka + 8) >> 2])) < 1)))
												)
													for (
														Ma = ((ta = q[(Ka + 16) >> 2]) + (Ba << 2)) | 0,
															...
															Aa = (q[(a + 28) >> 2] + (Da << 2)) | 0,
															Ba = q[(Ja + 936) >> 2];
														(q[Aa >> 2] = q[(Ba + ((Ca + q[ta >> 2]) << 2)) >> 2]),
															(Aa = (Aa + 4) | 0),
															(ta = (ta + 4) | 0) >>> 0 < Ma >>> 0;

													);
												if (q[(Ka + 28) >> 2] && !((0 | (Ba = q[(Ka + 8) >> 2])) < 1))
													for (
								...
								if ((n[q[1644]](a), (_a = q[(a + 316) >> 2]), 1 <= (0 | (ua = q[(a + 56) >> 2])))) {
									for (
										...
										;(Da = Ca),
											(ua = 0),
											q[(ta + 28) >> 2] &&
												((-1 != (0 | (Ea = q[ta >> 2])) && ((ua = 0), !q[(Ma + (Ea << 2)) >> 2])) ||
													(-1 != (0 | (Ea = q[(ta + 4) >> 2])) &&
														((ua = 0), !q[(Aa + (Ea << 2)) >> 2])) ||
													(ua = !q[(32 + ((w(q[Ba >> 2], 36) + _a) | 0)) >> 2])),
											(q[Da >> 2] = ua)
								...
								if (((Ea = q[a >> 2]), 1 <= (0 | (Ga = q[(a - -64) >> 2])))) {
									for (
										...
										if (
											((Ha = (w(q[La >> 2], 36) + _a) | 0),
											(q[(Ha + 28) >> 2] || q[(Ha + 24) >> 2]) &&
												((q[((Ca = ua << 2) + q[(a + 84) >> 2]) >> 2] = q[(Ha + 8) >> 2]),
												q[(Ha + 24) >> 2] && !((0 | (Ba = q[(Ha + 8) >> 2])) < 1)))
										)
											for (
								...
								if (1 <= (0 | (Xa = q[(a + 72) >> 2])))
									for (
										...
										if (
											((Wa = (w(q[Ya >> 2], 36) + _a) | 0),
											(q[(Wa + 28) >> 2] || q[(Wa + 24) >> 2]) &&
												((q[((ua = Ia << 2) + q[(a + 116) >> 2]) >> 2] = q[(Wa + 8) >> 2]),
												q[(Wa + 24) >> 2]))
										) {
											if (
												((ta = q[(Wa + 16) >> 2]),
								...
								if ((n[q[1642]](a), n[q[1645]](a), !((0 | (ua = q[(a + 200) >> 2])) < 1))) {
									for (
									...
									if (!((0 | (Ja = q[(a + 200) >> 2])) < 1))
										for (
											...
											if (
												((Qa = (Ha + w(q[ua >> 2], 36)) | 0),
												(q[(Qa + 28) >> 2] || q[(Qa + 24) >> 2]) &&
													((q[((Ca = Ia << 2) + q[(a + 212) >> 2]) >> 2] = q[(Qa + 8) >> 2]),
													q[(Qa + 24) >> 2] && !((0 | (Ba = q[(Qa + 8) >> 2])) < 1)))
											)
												for (
										...
										if (1 <= (0 | (ke = q[(a + 340) >> 2])))
											for (
												...
												if (
													((fe = (w(q[he >> 2], 36) + me) | 0),
													(q[(fe + 28) >> 2] || q[(fe + 24) >> 2]) &&
														((q[((de = ie << 2) + q[(a + 352) >> 2]) >> 2] = q[(fe + 8) >> 2]),
														q[(fe + 24) >> 2] && !((0 | (ge = q[(fe + 8) >> 2])) < 1)))
												)
													for (
														ee = q[(fe + 16) >> 2],
															ge = (ee + (ge << 2)) | 0,
															...
															de = (q[(a + 364) >> 2] + (je << 2)) | 0,
															pe = q[(le + 1104) >> 2];
														(q[de >> 2] = q[(((q[ee >> 2] + oe) << 2) + pe) >> 2]),
															(de = (de + 4) | 0),
															(ee = (ee + 4) | 0) >>> 0 < ge >>> 0;

													);
												if (q[(fe + 28) >> 2] && !((0 | (de = q[(fe + 8) >> 2])) < 1))
													for (
														ee = q[(fe + 20) >> 2],
															ge = (ee + (de << 2)) | 0,
															de = (q[(a + 356) >> 2] + (je << 2)) | 0;
								...
								if (1 <= (0 | (Ba = q[(a + 56) >> 2]))) {
									for (
										ua = (a + 56) | 0, ta = q[(a + 60) >> 2], Aa = q[(a + 168) >> 2], Ca = 0;
									...
									for (
										...
										q[Ca >> 2] &&
											...
											-1 != (0 | (Da = q[(ta + 4) >> 2])) &&
												...
												(Ea = (Ma + (Da << 5)) | 0),
												(Da = q[Ba >> 2]),
												n[q[(Ea + 20) >> 2]](q[(Ea + 24) >> 2], Da, Da, q[(ta + 12) >> 2]))),
											(Ba = (Ba + 4) | 0),
											(Aa = (Aa + 4) | 0),
											(Ca = (Ca + 4) | 0),
											(ta = (ta + 16) | 0) >>> 0 < Ja >>> 0;
								...
								if (
									(!(function(a) {
										...
										if (1 <= (0 | (Dd = q[(a + 340) >> 2])))
											for (
												Bd = q[(a + 344) >> 2], Td = (Bd + w(Dd, 24)) | 0, Dd = q[(a + 272) >> 2];
												;
									...
									for (
										...
										if (1 <= (0 | (Aa = q[(ua + 4) >> 2])))
											for (
												...
												(Ga = q[((Ca = (Da + (ta << 4)) | 0) + 4) >> 2] << 2),
													(Ca = 1 == q[(Ka = Ca) >> 2]),
													(q[(Ka + 12) >> 2] =
														q[
															(q[(Ga + (Ca ? Ma : La)) >> 2] ? (Ga + (Ca ? Oa : Ia)) | 0 : Ea) >> 2
														]),
													(0 | Aa) != (0 | (ta = (ta + 1) | 0));
									...
									for (Oa = q[(a + 264) >> 2], Ra = 0; ; ) {
										if (((Ga = (Ba + w(Ra, 28)) | 0), !(q[((Ja = Ga) + 24) >> 2] < 1))) {
											for (
												Ca = q[(a + 328) >> 2], ta = 0;
												(q[(Ca + (ta << 2)) >> 2] = -1),
													(0 | (ta = (ta + 1) | 0)) < (0 | (ua = q[(Ja + 24) >> 2]));
										...
										if (!(q[(Ga + 4) >> 2] < 1)) {
											for (
												Ma = q[(a + 332) >> 2], ta = 0;
												(q[(Ma + (ta << 2)) >> 2] = -1),
													(0 | (ta = (ta + 1) | 0)) < (0 | (ua = q[(Ga + 4) >> 2]));

											);
											if (!((0 | ua) < 1))
												for (
													Aa = q[(Ga + 12) >> 2], Ea = q[(a + 336) >> 2], ta = 0;
													(Da = (q[(12 + ((Aa + (ta << 4)) | 0)) >> 2] - q[(Ga + 20) >> 2]) << 2),
														(ua =
															-1 != (0 | (ua = q[(Ca = (Da + Ea) | 0) >> 2]))
																? (Ma + (ua << 2)) | 0
																: (Da + q[(a + 328) >> 2]) | 0),
														(q[ua >> 2] = ta),
														(0 | (ta = ((q[Ca >> 2] = ta) + 1) | 0)) < q[(Ga + 4) >> 2];

												);
										}
										if (1 <= (0 | (Ca = q[(Ja + 24) >> 2])))
											for (Aa = q[(Ga + 8) >> 2], Ma = q[(a + 328) >> 2], Ea = 0; ; ) {
												if (-1 != (0 | (ta = q[(Ma + (Ea << 2)) >> 2]))) {
													for (
														...
														(Aa =
															((ua =
																1 != q[(ua = (Ca + (ta << 4)) | 0) >> 2]
																	? ((q[(Oa + (q[(ua + 4) >> 2] << 2)) >> 2] = Aa), 1)
																	: ((ua = (Ba + w(q[(ua + 8) >> 2], 28)) | 0),
																	  (q[(ua + 8) >> 2] = Aa),
																	  q[ua >> 2])) +
																Aa) |
															0),
															(0 | ta) < (0 | (ua = q[(Da + (ta << 2)) >> 2])) &&
																-1 != (0 | (ta = ua));
								...
								M: {
									...
									if (!q[(a + 256) >> 2]) {
										...
										for (ta = 0; ; ) {
											if (
												(!q[((ua = ta << 2) + La) >> 2] | (u[(ua + q[(a + 276) >> 2]) >> 2] == x(0))
													? ((ua = (q[(a + 260) >> 2] + ta) | 0), (o[0 | ua] = 254 & r[0 | ua]))
													: ((ua = (q[(a + 260) >> 2] + ta) | 0), (o[0 | ua] = 1 | r[0 | ua])),
												(0 | Da) == (0 | (ta = (ta + 1) | 0)))
											)
												break M
											La = q[(a + 248) >> 2]
									...
									if (!(((q[(a + 256) >> 2] = 0) | Da) < 1))
										for (Aa = 0; ; ) {
											if (
												...
												(ta = Fa != u[(Ca + q[(a + 288) >> 2]) >> 2] ? 4 | ta : ta),
												(ta = q[(Ca + Ia) >> 2] == q[(Ca + q[(a + 284) >> 2]) >> 2] ? ta : 8 | ta),
												(ta =
													q[(Ca + q[(a + 264) >> 2]) >> 2] == q[(Ca + q[(a + 280) >> 2]) >> 2]
														? ta
														: 16 | ta),
												(o[0 | ua] = Ba ? 32 | ta : ta),
												(0 | Da) == (0 | (Aa = (Aa + 1) | 0)))
							...
							function ua(a, ab, bb) {
								var cb = 0,
									...
									lb = 0,
									mb = 0
								if (((q[ab >> 2] = 384), (db = q[a >> 2]), 1 <= (0 | (fb = q[db >> 2])))) {
									for (
										hb = q[(a + 16) >> 2], ib = q[(a + 296) >> 2];
										(eb = ((1 << q[(ib + (q[(hb + (cb << 2)) >> 2] << 2)) >> 2]) + eb) | 0),
											(0 | fb) != (0 | (cb = (cb + 1) | 0));
								...
								if (
									...
									for (
										kb = q[(a + 296) >> 2], lb = q[(a + 88) >> 2], jb = q[(a + 76) >> 2], fb = 0;
										(cb = (0 | cb) < (0 | (hb = q[((mb = eb << 2) + lb) >> 2])) ? hb : cb),
											(gb = (((15 + (hb << 3)) & -16) + gb) | 0),
											(fb = ((1 << q[(kb + (q[(jb + mb) >> 2] << 2)) >> 2]) + fb) | 0),
											(0 | ib) != (0 | (eb = (eb + 1) | 0));
								...
								if (
									...
									for (
										...
										(eb = ((1 << q[(hb + (q[(ib + (cb << 2)) >> 2] << 2)) >> 2]) + eb) | 0),
											(0 | fb) != (0 | (cb = (cb + 1) | 0));
								...
								if (
									...
									for (
										kb = q[(a + 136) >> 2], lb = q[(a + 296) >> 2], jb = q[(a + 172) >> 2], fb = 0;
										(cb = (0 | cb) < (0 | (ib = q[((mb = eb << 2) + jb) >> 2])) ? ib : cb),
											(gb = (((15 + (ib << 3)) & -16) + gb) | 0),
											(fb = ((1 << q[(lb + (q[(kb + mb) >> 2] << 2)) >> 2]) + fb) | 0),
											(0 | hb) != (0 | (eb = (eb + 1) | 0));
								...
								if (
									...
									for (
										ib = q[(a + 340) >> 2], kb = q[(a + 336) >> 2], lb = q[(a + 328) >> 2], eb = 0;
										(eb =
											(0 | (jb = (q[((gb = fb << 2) + kb) >> 2] - q[(gb + ib) >> 2]) | 0)) <
											(0 | eb)
												? eb
												: (jb + 1) | 0),
											(cb = (0 | cb) < (0 | (gb = q[(gb + lb) >> 2])) ? gb : cb),
											(0 | hb) != (0 | (fb = (fb + 1) | 0));
								...
								for (
									q[(ab + 284) >> 2] = w(fb, 24),
										...
										eb = 1;
									(cb =
										((((db = q[(a = ((eb << 2) + ab) | 0) >> 2]) + 15) & -16) + (q[a >> 2] = cb)) |
										0),
										77 != (0 | (eb = (eb + 1) | 0));
									...
									if ((a |= 0))
										if (ab)
													...
													(ab = (function(a, fh, gh) {
														...
														if (
															...
															if (
																...
																for (
																	ih = (jh + q[(92 + lh) >> 2]) | 0, mh = q[(a + 792) >> 2];
																	(q[(20 + ((kh + w(gh, 24)) | 0)) >> 2] = ih),
																		(ih =
																			(((15 + (q[(mh + (gh << 2)) >> 2] << 3)) & -16) + ih) | 0),
																		(0 | fh) != (0 | (gh = (gh + 1) | 0));
															...
															if (
																...
																for (
																	kh = 0;
																	(ih =
																		(((15 + (q[(q[(a + 876) >> 2] + (kh << 2)) >> 2] << 3)) & -16) +
																			ih) |
																		0),
																		(q[(q[(hh + 272) >> 2] + (gh << 2)) >> 2] = ih),
																		(0 | fh) != (0 | (gh = ((kh = gh) + 1) | 0));
															...
															if (((fh = q[(jh + 52) >> 2]), 1 <= (0 | (q[(hh + 304) >> 2] = fh))))
																for (
																	kh = q[(a + 1004) >> 2],
																		mh = q[(a + 1012) >> 2],
																		nh = q[(a + 1008) >> 2];
															...
															if (((fh = q[(jh + 48) >> 2]), 1 <= (0 | (q[(hh + 312) >> 2] = fh))))
																for (
																	kh = q[(a + 996) >> 2],
																		mh = q[(a + 992) >> 2],
																		nh = q[(a + 1e3) >> 2];
															...
															if (
																...
																for (
																	nh = q[(a + 732) >> 2],
																		...
																		ih = fh;
																	(kh = (gh = (ih + -1) | 0) << 2),
																		(q[(th = (sh + (gh << 3)) | 0) >> 2] = q[(kh + qh) >> 2]),
																		(q[(th + 4) >> 2] = q[(kh + oh) >> 2]),
																		(u[(kh + rh) >> 2] = q[(kh + nh) >> 2] ? x(1) : x(0)),
																		(kh = 1 < (0 | ih)),
																		(ih = gh),
																		kh;
															...
															if (
																...
																for (;;) {
																	;(ih = ((fh = ih) + -1) | 0),
																		(gh = (q[(hh + 60) >> 2] + (ih << 5)) | 0),
																		(kh = ih << 2),
																		(q[gh >> 2] = q[(kh + q[(a + 764) >> 2]) >> 2]),
																		(q[(gh + 4) >> 2] = q[(kh + q[(a + 768) >> 2]) >> 2]),
																		(jh = q[(kh + q[(a + 772) >> 2]) >> 2]),
																		(q[(gh + 8) >> 2] = jh),
																		(mh = q[(kh + q[(a + 776) >> 2]) >> 2]),
																		(q[(gh + 12) >> 2] = mh),
																		(q[(gh + 28) >> 2] = q[(kh + q[(a + 760) >> 2]) >> 2])
																	c: if (jh >>> 0 <= 1) {
																		if (jh - 1) {
																			;(q[(gh + 20) >> 2] = 1),
																				(q[(gh + 16) >> 2] = 2),
																				(q[(gh + 24) >> 2] = q[(hh + 68) >> 2] + w(mh, 24))
																			break c
																		}
																		;(q[(gh + 20) >> 2] = 3),
																			(q[(gh + 16) >> 2] = 4),
																			(q[(gh + 24) >> 2] = q[(hh + 76) >> 2] + (mh << 5))
																	} else Y(4, 1026, 0)
																	if (!(1 < (0 | fh))) break
																}
																jh = q[(a + 704) >> 2]
															...
															if (((gh = q[(jh + 12) >> 2]), 1 <= (0 | (q[(hh + 72) >> 2] = gh))))
																for (
																	mh = q[(a + 816) >> 2], ph = q[(hh + 76) >> 2], ih = gh;
																	(q[(ph + ((kh = (ih + -1) | 0) << 5)) >> 2] =
																		q[(mh + (kh << 2)) >> 2]),
																		(nh = 1 < (0 | ih)),
																		(ih = kh),
															...
															if (
																...
																for (
																	mh = q[(hh + 208) >> 2], nh = q[(hh + 316) >> 2], gh = 0;
																	(kh =
																		q[
																			(4 +
																				((nh +
																					w(q[((oh = (fh = (ih + -1) | 0) << 2) + ph) >> 2], 36)) |
																					0)) >>
																				2
																		]),
																		(q[(mh + oh) >> 2] = kh),
															...
															if (
																...
																if (!((0 | (gh = q[(hh + 340) >> 2])) < 1))
																	for (
																		jh = q[(hh + 348) >> 2], ph = q[(hh + 316) >> 2];
																		(kh =
																			q[
																				(4 +
																					((ph +
																						w(
																							q[((nh = (ih = (gh + -1) | 0) << 2) + mh) >> 2],
																							36
																						)) |
																						0)) >>
																					2
											...
											(q[(20 + nb) >> 2] = 1246),
												(q[(16 + nb) >> 2] = 1846),
												Y(4, 1087, (16 + nb) | 0)
									else (q[(4 + nb) >> 2] = 1828), (q[nb >> 2] = 1846), Y(4, 1087, nb)
									ab = 0
								}
								return (L = (nb + 64) | 0), 0 | ab
							}
							function wa(a) {
								var ab
								return (
									...
									(a = (a |= 0)
										...
										: ((q[(4 + ab) >> 2] = 1828), (q[ab >> 2] = 1810), Y(4, 1087, ab), 0)),
									(L = (16 + ab) | 0),
									0 | a
								)
							}
							function xa(a, bb) {
								...
								a: {
									b: if (!(1 & (ob = q[(a + 4) >> 2]))) {
										if (!(3 & ob)) break a
										if (((bb = ((ob = q[a >> 2]) + bb) | 0), (0 | (a = (a - ob) | 0)) == q[1928])) {
											if (3 == (3 & (ob = q[(rb + 4) >> 2])))
												return (
													(q[1925] = bb),
													(q[(rb + 4) >> 2] = -2 & ob),
											...
											if (ob >>> 0 <= 255) {
												if (
													...
													;(ub = 7692), (vb = q[1923] & jc(qb)), (q[ub >> 2] = vb)
													break b
												}
												;(q[(ob + 12) >> 2] = pb), (q[(pb + 8) >> 2] = ob)
												break b
											}
											if (((tb = q[(a + 24) >> 2]), (0 | (ob = q[(a + 12) >> 2])) == (0 | a)))
												if (
													(qb = q[(pb = (a + 20) | 0) >> 2]) ||
													(qb = q[(pb = (a + 16) | 0) >> 2])
												) {
													for (
														...
														(sb = pb),
															(qb = q[(pb = ((ob = qb) + 20) | 0) >> 2]) ||
																((pb = (ob + 16) | 0), (qb = q[(ob + 16) >> 2]));

													);
													q[sb >> 2] = 0
												} else ob = 0
											else (pb = q[(a + 8) >> 2]), (q[(pb + 12) >> 2] = ob), (q[(ob + 8) >> 2] = pb)
											if (!tb) break b
											pb = q[(a + 28) >> 2]
											e: {
												if (q[(qb = (7996 + (pb << 2)) | 0) >> 2] == (0 | a)) {
													if ((q[qb >> 2] = ob)) break e
													;(ub = 7696), (vb = q[1924] & jc(pb)), (q[ub >> 2] = vb)
													break b
												}
												if (!(q[(tb + (q[(tb + 16) >> 2] == (0 | a) ? 16 : 20)) >> 2] = ob)) break b
											}
											if (
												((q[(ob + 24) >> 2] = tb),
												(pb = q[(a + 16) >> 2]) &&
									...
									f: {
										if (!(2 & (ob = q[(rb + 4) >> 2]))) {
											...
											g: if (ob >>> 0 <= 255) {
												...
												if (((tb = q[(rb + 24) >> 2]), (0 | rb) == (0 | (ob = q[(rb + 12) >> 2]))))
													if (
														(qb = q[(pb = (rb + 20) | 0) >> 2]) ||
														(qb = q[(pb = (rb + 16) | 0) >> 2])
													) {
													...
													(pb = q[(rb + 8) >> 2]), (q[(pb + 12) >> 2] = ob), (q[(ob + 8) >> 2] = pb)
												if (tb) {
													pb = q[(rb + 28) >> 2]
													j: {
														if (q[(qb = (7996 + (pb << 2)) | 0) >> 2] == (0 | rb)) {
															if ((q[qb >> 2] = ob)) break j
															;(ub = 7696), (vb = q[1924] & jc(pb)), (q[ub >> 2] = vb)
															break g
														}
														if (!(q[(tb + (q[(tb + 16) >> 2] == (0 | rb) ? 16 : 20)) >> 2] = ob))
															break g
													}
													;(q[(ob + 24) >> 2] = tb),
														(pb = q[(rb + 16) >> 2]) &&
											...
											if (((q[(a + 4) >> 2] = 1 | bb), (q[(a + bb) >> 2] = bb), q[1928] != (0 | a)))
												break f
									...
									m: {
										if ((pb = q[1924]) & (sb = 1 << ob)) {
											for (
												pb = bb << (31 == (0 | ob) ? 0 : (25 - (ob >>> 1)) | 0), ob = q[qb >> 2];
												;
										...
										return (
											(q[(a + 24) >> 2] = qb), (q[(a + 12) >> 2] = a), void (q[(a + 8) >> 2] = a)
										)
									}
									;(bb = q[(qb + 8) >> 2]),
										(q[(bb + 12) >> 2] = a),
								...
								a: {
									if (8 != (0 | bb)) {
										...
										bb = (function(a, _h) {
											...
											if ((-64 - a) >>> 0 <= _h >>> 0) return (q[1906] = 48), 0
											if (
												!($h = ja(
													(12 + (((ai = _h >>> 0 < 11 ? 16 : (_h + 11) & -8) + a) | 0)) | 0
												))
											)
												return 0
											_h = ($h + -8) | 0
											$h & (a + -1)
												? ((ei = q[(di = ($h + -4) | 0) >> 2]),
												  (ci =
														...
														0),
												  3 & ei
														? ((q[(a + 4) >> 2] = ci | (1 & q[(a + 4) >> 2]) | 2),
														  (q[((ci = (a + ci) | 0) + 4) >> 2] = 1 | q[(ci + 4) >> 2]),
														  (q[di >> 2] = $h | (1 & q[di >> 2]) | 2),
														  (q[(a + 4) >> 2] = 1 | q[(a + 4) >> 2]),
														  xa(_h, $h))
														: ((_h = q[_h >> 2]), (q[(a + 4) >> 2] = ci), (q[a >> 2] = _h + $h)))
												: (a = _h)
											3 & (_h = q[(a + 4) >> 2]) &&
												(($h = -8 & _h) >>> 0 <= (ai + 16) >>> 0 ||
													((q[(a + 4) >> 2] = ai | (1 & _h) | 2),
							...
							function za(a) {
								var bb = 0,
									...
									Eb = 0
								a: if (a) {
									Ab = ((yb = (a + -8) | 0) + (a = -8 & (wb = q[(a + -4) >> 2]))) | 0
									b: if (!(1 & wb)) {
										if (!(3 & wb)) break a
										if ((yb = (yb - (wb = q[yb >> 2])) | 0) >>> 0 < t[1927]) break a
										if (((a = (a + wb) | 0), q[1928] == (0 | yb))) {
											...
											if (wb >>> 0 <= 255) {
												if (
													...
													;(Db = 7692), (Eb = q[1923] & jc(wb)), (q[Db >> 2] = Eb)
													break b
												}
												;(q[(zb + 12) >> 2] = bb), (q[(bb + 8) >> 2] = zb)
												break b
											}
											if (((Cb = q[(yb + 24) >> 2]), (0 | yb) == (0 | (wb = q[(yb + 12) >> 2]))))
												if (
													(bb = q[(zb = (yb + 20) | 0) >> 2]) ||
													(bb = q[(zb = (yb + 16) | 0) >> 2])
												) {
													for (
														...
														(Bb = zb),
															(bb = q[(zb = ((wb = bb) + 20) | 0) >> 2]) ||
																((zb = (wb + 16) | 0), (bb = q[(wb + 16) >> 2]));

													);
													q[Bb >> 2] = 0
												} else wb = 0
											else
												(bb = q[(yb + 8) >> 2]), (q[(bb + 12) >> 2] = wb), (q[(wb + 8) >> 2] = bb)
											if (!Cb) break b
											zb = q[(yb + 28) >> 2]
											e: {
												if (q[(bb = (7996 + (zb << 2)) | 0) >> 2] == (0 | yb)) {
													if ((q[bb >> 2] = wb)) break e
													;(Db = 7696), (Eb = q[1924] & jc(zb)), (q[Db >> 2] = Eb)
													break b
												}
												if (!(q[(Cb + (q[(Cb + 16) >> 2] == (0 | yb) ? 16 : 20)) >> 2] = wb))
													break b
											}
											if (
												((q[(wb + 24) >> 2] = Cb),
										...
										f: {
											if (!(2 & wb)) {
												...
												g: if (wb >>> 0 <= 255) {
													...
													if (
														((Cb = q[(Ab + 24) >> 2]), (0 | Ab) == (0 | (wb = q[(Ab + 12) >> 2])))
													)
														if (
															(bb = q[(zb = (Ab + 20) | 0) >> 2]) ||
															(bb = q[(zb = (Ab + 16) | 0) >> 2])
													...
													if (Cb) {
														zb = q[(Ab + 28) >> 2]
														j: {
															if (q[(bb = (7996 + (zb << 2)) | 0) >> 2] == (0 | Ab)) {
																if ((q[bb >> 2] = wb)) break j
																;(Db = 7696), (Eb = q[1924] & jc(zb)), (q[Db >> 2] = Eb)
																break g
															}
															if (!(q[(Cb + (q[(Cb + 16) >> 2] == (0 | Ab) ? 16 : 20)) >> 2] = wb))
																break g
														}
														;(q[(wb + 24) >> 2] = Cb),
															(bb = q[(Ab + 16) >> 2]) &&
												...
												if (
													((q[(yb + 4) >> 2] = 1 | a), (q[(a + yb) >> 2] = a), q[1928] != (0 | yb))
												)
													break f
													...
													(bb =
														(28 +
															(((bb =
																...
																((a >>> (bb + 21)) & 1))) |
														0))),
											(Bb = (7996 + ((q[((wb = yb) + 28) >> 2] = bb) << 2)) | 0)
										m: if ((zb = q[1924]) & (wb = 1 << bb)) {
											;(zb = a << (31 == (0 | bb) ? 0 : (25 - (bb >>> 1)) | 0)), (wb = q[Bb >> 2])
											n: {
												for (;;) {
													if ((-8 & q[((bb = wb) + 4) >> 2]) == (0 | a)) break n
													if (
														((wb = zb >>> 29),
														(zb <<= 1),
														!(wb = q[((Bb = (bb + (4 & wb)) | 0) + 16) >> 2]))
													)
														break
												}
												;(q[(Bb + 16) >> 2] = yb),
							...
							function Aa(a, Fb) {
									...
									c: {
										d: {
											e: {
												...
												if (2139095040 != (0 | Ib)) {
													if (!Ib | !(Hb >>> 0 <= (Ib + 218103808) >>> 0 && 2139095040 != (0 | Hb)))
														break b
													if (
														(((Hb + 218103808) >>> 0 < Ib >>> 0 && ((Kb = x(0)), Lb)) ||
															(Kb = ka(x(y(x(a / Fb))))),
														(a = Kb),
														Gb >>> 0 <= 2)
													) {
								...
								return x((0 | Jb) < 0 ? -1.5707963705062866 : 1.5707963705062866)
							}
							function Da(a, Ub, Vb) {
								var Zb,
									bc,
								...
								if (
									...
									(cc =
										((Xb = Vb) +
											w((gc = 0 < (0 | (Vb = (((Vb + -3) | 0) / 24) | 0)) ? Vb : 0), -24)) |
										0),
									0 <= (0 | (bc = q[808])))
								)
									for (
								...
								for (ac = (cc + -24) | 0, Xb = 0; ; ) {
									for (
										Wb = Vb = 0;
										(Wb += v[((Vb << 3) + a) >> 3] * v[(((320 + Zb) | 0) + ((Xb - Vb) << 3)) >> 3]),
											1 != (0 | (Vb = (Vb + 1) | 0));
								...
								a: {
									for (;;) {
										if (((Wb = v[((Xb << 3) + Zb) >> 3]), !(ec = ((Vb = 0) | (Yb = Xb)) < 1)))
											for (
												;
												($b = (((480 + Zb) | 0) + (Vb << 2)) | 0),
													(dc = Wb),
													(_b = y((Wb *= 5.960464477539063e-8)) < 2147483648 ? ~~Wb : -2147483648),
													(_b =
														y((dc += -16777216 * (Wb = +(0 | _b)))) < 2147483648
															? ~~dc
															: -2147483648),
													(q[$b >> 2] = _b),
													(Wb = v[((($b = (Yb + -1) | 0) << 3) + Zb) >> 3] + Wb),
													(Vb = (Vb + 1) | 0),
													(_b = 1 < (0 | Yb)),
													(Yb = $b),
													_b;
										...
										;(Wb = ha(Wb, ac)),
											(Wb += -8 * C(0.125 * Wb)),
											(Wb -= 0 | ($b = y(Wb) < 2147483648 ? ~~Wb : -2147483648))
										e: {
											f: {
												g: {
													if ((ic = (0 | ac) < 1)) {
														...
														(fc = Yb = ((Xb << 2) + Zb) | 0),
															(Yb = ((_b = q[(Yb + 476) >> 2]) - ((Vb = _b >> hc) << hc)) | 0),
															($b = (Vb + $b) | 0),
															(_b = (q[(fc + 476) >> 2] = Yb) >> kc)
													if ((0 | _b) < 1) break e
													break f
											...
											if (((Yb = Vb = 0), !ec))
												for (;;) {
													;(ec = q[(jc = (((480 + Zb) | 0) + (Vb << 2)) | 0) >> 2]), (fc = 16777215)
													i: {
														j: {
															if (!Yb) {
																if (!ec) break j
											...
											ic ||
												1 < (Vb = (ac + -1) | 0) >>> 0 ||
												(q[((Vb = ((Xb << 2) + Zb) | 0) + 476) >> 2] =
													Vb - 1 ? 8388607 & q[(Vb + 476) >> 2] : 4194303 & q[(Vb + 476) >> 2]),
												($b = ($b + 1) | 0),
												2 == (0 | _b) && ((Wb = 1 - Wb), (_b = 2), Yb && (Wb -= ha(1, ac)))
										}
										if (0 != Wb) break
										if (!(((Yb = 0) | (Vb = Xb)) <= (0 | bc))) {
											for (
												;
												(Yb = q[(((480 + Zb) | 0) + ((Vb = (Vb + -1) | 0) << 2)) >> 2] | Yb),
													(0 | bc) < (0 | Vb);
										...
										for (
											Vb = 1;
											(Vb = ((Yb = Vb) + 1) | 0), !q[(((480 + Zb) | 0) + ((bc - Yb) << 2)) >> 2];
										...
										for (Yb = (Xb + Yb) | 0; ; ) {
											for (
												Xb = $b = (Xb + 1) | 0,
													...
													Wb = Vb = 0;
												(Wb +=
													v[((Vb << 3) + a) >> 3] * v[(((320 + Zb) | 0) + (($b - Vb) << 3)) >> 3]),
													1 != (0 | (Vb = (Vb + 1) | 0));

											);
											if (((v[((Xb << 3) + Zb) >> 3] = Wb), !((0 | Xb) < (0 | Yb)))) break
										}
										Xb = Yb
									}
									16777216 <= (Wb = ha(Wb, (0 - ac) | 0))
										? ((a = (((480 + Zb) | 0) + (Xb << 2)) | 0),
										  (dc = Wb),
										  (Vb = y((Wb *= 5.960464477539063e-8)) < 2147483648 ? ~~Wb : -2147483648),
										  (Yb = y((Wb = dc + -16777216 * (0 | Vb))) < 2147483648 ? ~~Wb : -2147483648),
										  (q[a >> 2] = Yb),
										  (Xb = (Xb + 1) | 0))
										: ((Vb = y(Wb) < 2147483648 ? ~~Wb : -2147483648), (cc = ac)),
										(q[(((480 + Zb) | 0) + (Xb << 2)) >> 2] = Vb)
								}
								if (((Wb = ha(1, cc)), !((0 | Xb) <= -1))) {
									for (
										Vb = Xb;
										(v[((Vb << 3) + Zb) >> 3] = Wb * q[(((480 + Zb) | 0) + (Vb << 2)) >> 2]),
									...
									if (!((0 | Xb) <= -1))
										for (Vb = Xb; ; ) {
											for (
												...
												(Wb += v[(6016 + (Vb << 3)) >> 3] * v[(((a + Vb) << 3) + Zb) >> 3]),
													!((0 | bc) <= (0 | Vb)) &&
														((ac = Vb >>> 0 < Yb >>> 0), (Vb = (Vb + 1) | 0), ac);
								...
								return (v[Ub >> 3] = _b ? -Wb : Wb), (L = (560 + Zb) | 0), 7 & $b
							}
							function Ea(a, Ub, Vb, lc) {
								var oc,
									qc,
									rc,
									mc = 0,
								...
								;(L = oc = (L - 32) | 0),
									...
									(mc = (qc + -1140785152) | 0),
									pc >>> 0 < 0 && (mc = (mc + 1) | 0)
								a: if ((((0 | mc) == (0 | nc)) & (rc >>> 0 < pc >>> 0)) | (nc >>> 0 < mc >>> 0)) {
									if (
										((mc = (lc << 4) | (Vb >>> 28)),
										(Vb = (Vb << 4) | (Ub >>> 28)),
										((134217728 == (0 | (pc = Ub &= 268435455))) & (1 <= a >>> 0)) |
											(134217728 < Ub >>> 0))
									) {
										;(mc = (mc + 1073741824) | 0),
									...
									if (
										((mc = (mc - ((((nc = Vb) >>> 0 < 0) + -1073741824) | 0)) | 0),
										a | (134217728 ^ pc))
									)
										break a
									;(a = (nc + (1 & nc)) | 0) >>> 0 < nc >>> 0 && (mc = (mc + 1) | 0), (nc = a)
								} else
									(!pc & (2147418112 == (0 | qc))
									? !(a | Ub)
									: ((2147418112 == (0 | qc)) & (pc >>> 0 < 0)) | (qc >>> 0 < 2147418112))
										? ((mc = 2146435072),
										  ((1140785151 == ((nc = 0) | qc)) & (4294967295 < pc >>> 0)) |
												(1140785151 < qc >>> 0) ||
												(pc = qc >>> 16) >>> (mc = 0) < 15249 ||
												((function(a, Ub, Vb, lc, tc, uc) {
													...
													;(q[a >> 2] = Ub),
														...
														(q[(a + 8) >> 2] = lc),
														(q[(a + 12) >> 2] = tc)
												})(oc, a, Ub, Vb, (mc = (65535 & lc) | 65536), (15361 - pc) | 0),
												(function(a, Ub, Vb, lc, tc, uc) {
													var vc = 0,
														wc = 0,
														xc = 0,
												...
												((134217728 == (0 | (Vb = a = 268435455 & Vb))) &
													(1 <=
														(Ub =
															q[oc >> 2] |
															((0 != (q[(16 + oc) >> 2] | q[(24 + oc) >> 2])) |
																(0 != (q[(20 + oc) >> 2] | q[(28 + oc) >> 2])))) >>>
															0)) |
												(134217728 < a >>> 0)
													? ((a = (nc + 1) | 0) >>> 0 < 1 && (mc = (mc + 1) | 0), (nc = a))
													: Ub | (134217728 ^ Vb) ||
													  ((a = (nc + (1 & nc)) | 0) >>> 0 < nc >>> 0 && (mc = (mc + 1) | 0),
													  (nc = a))))
										: ((nc = (Vb << 4) | (Ub >>> 28)),
										  (mc = (524287 & (mc = (lc << 4) | (Vb >>> 28))) | 2146959360))
								return (L = (32 + oc) | 0), f(0, 0 | nc), f(1, (-2147483648 & lc) | mc), +g()
							}
							function Ia(a, Ub) {
								var Vb = 0,
									lc = 0,
									...
									b: {
										c: {
											d: if (!(!Ub | !(3 & a)))
												for (;;) {
													if (!r[0 | a]) break c
													if (((a = (a + 1) | 0), (Vb = 0 != (0 | (Ub = (Ub + -1) | 0))), !Ub))
														break d
													if (!(3 & a)) break
												}
											if (!Vb) break b
										...
										e: {
											if (4 <= Ub >>> 0) {
												for (
													...
													if (((a = (a + 4) | 0), !(3 < (Ub = (Ub + -4) | 0) >>> 0))) break
												}
												;(Ub = Vb), (a = lc)
											}
											if (!Ub) break b
							...
							function Na(a, Ub, Fc, Gc) {
								if (a | Ub)
									for (
										;
										(o[0 | (Fc = (Fc + -1) | 0)] = r[(3168 + (15 & a)) | 0] | Gc),
											(a = ((15 & Ub) << 28) | (a >>> 4)) | (Ub >>>= 4);
							...
							function ab(a) {
								...
								;(q[(L = sd = (L - 16) | 0) >> 2] = a),
									(function(a, Fc) {
										var gd
										ra(a, 1176, (q[(12 + (L = gd = (L - 16) | 0)) >> 2] = Fc), 0, 0),
											(L = (16 + gd) | 0)
									})(q[670], sd),
									(L = (16 + sd) | 0)
							}
							function jb(a) {
								...
								if (
									...
									(function(a) {
										var td
										sa((16 + (L = td = (L - 272) | 0)) | 0, 1611, (q[(12 + td) >> 2] = a)),
											ab((16 + td) | 0),
											(L = (272 + td) | 0)
									})((16 + Ve) | (q[(20 + Ve) >> 2] = 0)),
									ma(a))
									...
									(q[(4 + Ve) >> 2] = re), (q[Ve >> 2] = 3), Y(4, 1332, Ve), (a = 0)
								else {
									for (
										1 != (0 | (We = !r[(a + 5) | 0])) &&
											(ca((a + 4) | 0, 1), X((a - -64) | 0, 4, 160), (o[(a + 5) | 0] = 0)),
											qe = (a - -64) | 0,
											Je = 102,
											re = (a + 704) | 0;
										(q[re >> 2] = q[qe >> 2] + a),
									...
									if (
										(1 != (0 | We) &&
											...
											X(q[(a + 804) >> 2], 4, q[(q[(a + 704) >> 2] + 12) >> 2]),
											X(q[(a + 808) >> 2], 4, q[(q[(a + 704) >> 2] + 12) >> 2]),
											X(q[(a + 812) >> 2], 4, q[(q[(a + 704) >> 2] + 12) >> 2]),
											X(q[(a + 816) >> 2], 4, q[(q[(a + 704) >> 2] + 12) >> 2]),
											X(q[(a + 840) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 844) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 848) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											...
											X(q[(a + 872) >> 2], 1, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 876) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 880) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 884) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 888) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 892) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 896) >> 2], 4, q[(q[(a + 704) >> 2] + 16) >> 2]),
											X(q[(a + 908) >> 2], 4, q[(q[(a + 704) >> 2] + 20) >> 2]),
											X(q[(a + 912) >> 2], 4, q[(q[(a + 704) >> 2] + 20) >> 2]),
											X(q[(a + 916) >> 2], 4, q[(q[(a + 704) >> 2] + 20) >> 2]),
											X(q[(a + 920) >> 2], 4, q[(q[(a + 704) >> 2] + 20) >> 2]),
											X(q[(a + 924) >> 2], 4, q[(q[(a + 704) >> 2] + 20) >> 2]),
											X(q[(a + 928) >> 2], 4, q[(q[(a + 704) >> 2] + 20) >> 2]),
											X(q[(a + 932) >> 2], 4, q[(q[(a + 704) >> 2] + 20) >> 2]),
											X(q[(a + 936) >> 2], 4, q[(q[(a + 704) >> 2] + 24) >> 2]),
											X(q[(a + 940) >> 2], 4, q[(q[(a + 704) >> 2] + 28) >> 2]),
											X(q[(a + 944) >> 2], 4, q[(q[(a + 704) >> 2] + 28) >> 2]),
											X(q[(a + 948) >> 2], 4, q[(q[(a + 704) >> 2] + 32) >> 2]),
											X(q[(a + 952) >> 2], 4, q[(q[(a + 704) >> 2] + 32) >> 2]),
											X(q[(a + 956) >> 2], 4, q[(q[(a + 704) >> 2] + 32) >> 2]),
											X(q[(a + 960) >> 2], 4, q[(q[(a + 704) >> 2] + 32) >> 2]),
											X(q[(a + 964) >> 2], 4, q[(q[(a + 704) >> 2] + 32) >> 2]),
											X(q[(a + 968) >> 2], 4, q[(q[(a + 704) >> 2] + 32) >> 2]),
											X(q[(a + 972) >> 2], 4, q[(q[(a + 704) >> 2] + 32) >> 2]),
											X(q[(a + 976) >> 2], 4, q[(q[(a + 704) >> 2] + 36) >> 2]),
											X(q[(a + 980) >> 2], 4, q[(q[(a + 704) >> 2] + 36) >> 2]),
											X(q[(a + 984) >> 2], 4, q[(q[(a + 704) >> 2] + 36) >> 2]),
											X(q[(a + 988) >> 2], 4, q[(q[(a + 704) >> 2] + 40) >> 2]),
											X(q[(a + 992) >> 2], 4, q[(q[(a + 704) >> 2] + 44) >> 2]),
											X(q[(a + 996) >> 2], 4, q[(q[(a + 704) >> 2] + 48) >> 2]),
											X(q[(a + 1e3) >> 2], 4, q[(q[(a + 704) >> 2] + 48) >> 2]),
											X(q[(a + 1004) >> 2], 4, q[(q[(a + 704) >> 2] + 52) >> 2]),
											X(q[(a + 1008) >> 2], 4, q[(q[(a + 704) >> 2] + 52) >> 2]),
											X(q[(a + 1012) >> 2], 4, q[(q[(a + 704) >> 2] + 56) >> 2]),
											X(q[(a + 1016) >> 2], 4, q[(q[(a + 704) >> 2] + 60) >> 2]),
											X(q[(a + 1020) >> 2], 2, q[(q[(a + 704) >> 2] + 64) >> 2]),
											X(q[(a + 1024) >> 2], 4, q[(q[(a + 704) >> 2] + 68) >> 2]),
											X(q[(a + 1028) >> 2], 4, q[(q[(a + 704) >> 2] + 72) >> 2]),
											X(q[(a + 1032) >> 2], 4, q[(q[(a + 704) >> 2] + 72) >> 2]),
											X(q[(a + 1036) >> 2], 4, q[(q[(a + 704) >> 2] + 72) >> 2]),
											X(q[(a + 1040) >> 2], 4, q[(q[(a + 704) >> 2] + 72) >> 2]),
											X(q[(a + 1044) >> 2], 4, q[(q[(a + 704) >> 2] + 72) >> 2]),
											X(q[(a + 1048) >> 2], 4, q[(q[(a + 704) >> 2] + 76) >> 2]),
											X(q[(a + 1052) >> 2], 4, q[(q[(a + 704) >> 2] + 76) >> 2]),
											X(q[(a + 1056) >> 2], 4, q[(q[(a + 704) >> 2] + 76) >> 2]),
											X(q[(a + 1068) >> 2], 4, q[(q[(a + 704) >> 2] + 80) >> 2]),
											X(q[(a + 1072) >> 2], 4, q[(q[(a + 704) >> 2] + 80) >> 2]),
											X(q[(a + 1076) >> 2], 4, q[(q[(a + 704) >> 2] + 80) >> 2]),
											X(q[(a + 1080) >> 2], 4, q[(q[(a + 704) >> 2] + 80) >> 2]),
											X(q[(a + 1084) >> 2], 4, q[(q[(a + 704) >> 2] + 80) >> 2]),
											X(q[(a + 1088) >> 2], 4, q[(q[(a + 704) >> 2] + 80) >> 2]),
											X(q[(a + 1092) >> 2], 4, q[(q[(a + 704) >> 2] + 80) >> 2]),
											X(q[(a + 1096) >> 2], 4, q[(q[(a + 704) >> 2] + 84) >> 2]),
											X(q[(a + 1100) >> 2], 2, q[(q[(a + 704) >> 2] + 84) >> 2]),
											X(q[(a + 1104) >> 2], 4, q[(q[(a + 704) >> 2] + 88) >> 2]),
											re >>> 0 < 2 || X(q[(a + 1108) >> 2], 4, q[(q[(a + 704) >> 2] + 8) >> 2])),
										(q[1643] = 5),
										(q[1642] = 6),
										(q[1644] = 7),
										(q[1645] = 8),
										...
										for (
											re = 0;
											(q[(q[(a + 712) >> 2] + (re << 2)) >> 2] = q[(a + 716) >> 2] + (re << 6)),
												(re = (re + 1) | 0),
												(qe = q[(a + 704) >> 2]),
												(0 | re) < q[qe >> 2];
									...
									if (1 <= q[(qe + 4) >> 2])
										for (
											re = 0;
											(q[(q[(a + 744) >> 2] + (re << 2)) >> 2] = q[(a + 748) >> 2] + (re << 6)),
												(re = (re + 1) | 0),
												(qe = q[(a + 704) >> 2]),
												(0 | re) < q[(qe + 4) >> 2];
									...
									if (1 <= q[(qe + 16) >> 2])
										for (
											re = 0;
											(q[((qe = re << 2) + q[(a + 820) >> 2]) >> 2] =
												q[(a + 836) >> 2] + (re << 6)),
												(q[(qe + q[(a + 824) >> 2]) >> 2] =
													q[(a + 1016) >> 2] + (q[(qe + q[(a + 880) >> 2]) >> 2] << 2)),
												(q[(qe + q[(a + 828) >> 2]) >> 2] =
													q[(a + 1020) >> 2] + (q[(qe + q[(a + 884) >> 2]) >> 2] << 1)),
												(q[(qe + q[(a + 832) >> 2]) >> 2] =
													q[(a + 1024) >> 2] + (q[(qe + q[(a + 892) >> 2]) >> 2] << 2)),
												(re = (re + 1) | 0),
												(qe = q[(a + 704) >> 2]),
												(0 | re) < q[(qe + 16) >> 2];
									...
									if (1 <= q[(qe + 20) >> 2])
										for (
											re = 0;
											(q[(q[(a + 900) >> 2] + (re << 2)) >> 2] = q[(a + 904) >> 2] + (re << 6)),
												(re = (re + 1) | 0),
												(qe = q[(a + 704) >> 2]),
												(0 | re) < q[(qe + 20) >> 2];
									...
									if (1 <= q[(qe + 80) >> 2])
										for (
											re = 0;
											(q[(q[(a + 1060) >> 2] + (re << 2)) >> 2] = q[(a + 1064) >> 2] + (re << 6)),
												(re = (re + 1) | 0),
												(qe = q[(a + 704) >> 2]),
												(0 | re) < q[(qe + 80) >> 2];
									...
									if (
										!(1 & o[(q[(a + 708) >> 2] + 20) | 0] || (0 | (We = q[(qe + 16) >> 2])) < 1)
									) {
										for (
											Ye = q[(a + 888) >> 2],
												Ze = q[(a + 884) >> 2],
											...
											if (1 < (0 | (Je = q[((qe = re << 2) + Ye) >> 2])))
												for (
													_e = (Je + -1) | 0, $e = (Xe + (q[(qe + Ze) >> 2] << 1)) | 0, qe = 0;
													(af = s[(Je = ((qe << 1) + $e) | 0) >> 1]),
														(p[Je >> 1] = s[(Je + 4) >> 1]),
														(p[(Je + 4) >> 1] = af),
														(0 | (qe = (qe + 3) | 0)) < (0 | _e);
										...
										for (
											...
											if (1 <= (0 | (Xe = q[((qe = Je << 2) + re) >> 2])))
												for (
													Xe = ((qe = (Ze + (q[(qe + Ye) >> 2] << 2)) | 0) + (Xe << 3)) | 0,
														qe = (qe + 4) | 0;
													(u[qe >> 2] = x(1) - u[qe >> 2]), (qe = (qe + 8) | 0) >>> 0 < Xe >>> 0;

												);
											if ((0 | We) == (0 | (Je = (Je + 1) | 0))) break
										}
									}
								}
								return (L = (32 + Ve) | 0), a
								...
								a: {
									b: {
										if ((j(a), (hi = 2147483647 & (gi = e(0))))) {
											if (!(hi >>> 0 < 2139095041)) return x(x(0.10000000149011612) + a)
											if (1065353216 == (0 | hi)) return x(-1 < (0 | gi) ? 0.10000000149011612 : 10)
											if (2139095040 == (0 | hi)) return x(-1 < (0 | gi) ? 0 : -a)
											if (1073741824 == (0 | gi)) return x(0.010000000707805157)
											if (1056964608 == (0 | gi)) return x(0.3162277638912201)
											if (1291845633 <= hi >>> 0) return x((0 | gi) < 0 ? H : 0)
											if (
												((ii = u[1537]),
													...
													ki *
														x(
															x(ji - x((ni = _h) * x(3.099609375))) -
																x(_h * x(x(1.600000023841858) - x(x(3.099609375) - ii)))
														)
												)),
												(ki = x(x(fi + _h) * ii)),
												(_h = x(fi * fi)),
												...
												(_h = k()),
												(ki = x(ni * _h)),
												(fi = x(x(ii * _h) + x(fi * x(ji - x(x(_h + x(-3)) - li))))),
												...
												(ji = k()),
												(_h = x(fi * ji)),
												(a = x(x(x(li - x(x(x(fi - x(-4)) - oi) - ii)) * a) + x(x(a - ji) * fi))),
												j((fi = x(_h + a))),
												1124073473 <= (0 | (gi = e(0))))
											)
												break b
											d: {
												e: {
													if ((hi = 1124073472) == (0 | gi)) {
														if (!(x(a + x(4.299566569443414e-8)) > x(fi - _h))) break e
														break b
													}
													if (
														((hi = 2147483647 & gi),
														!(((a <= x(fi - _h)) ^ 1) | (-1021968384 != (0 | gi))) |
															(1125515265 <= hi >>> 0))
													)
														break a
												...
												;(mi =
													((8388607 & (hi = ((8388608 >>> ((hi >>> 23) - 126)) + gi) | 0)) |
														8388608) >>>
													(150 - (pi = (hi >>> 23) & 255))),
													(mi = (0 | gi) < 0 ? (0 - mi) | 0 : mi),
													(_h = x(_h - (f(0, hi & (-8388608 >> (pi + -127))), k()))),
													j(x(a + _h)),
													(gi = e(0))
											}
											f(0, -32768 & gi),
												...
												(a =
													(0 |
														(gi =
															0 |
															(j((a = x(x(a - x(ni - x(_h + x(a * _h)))) + x(1)))),
															e(0) + (mi << 23)))) <=
													8388607
														? (function(a, qi) {
																a: if (128 <= (0 | qi)) {
																	if (((a = x(a * x(17014118346046923e22))), (0 | qi) < 255)) {
																		qi = (qi + -127) | 0
																		break a
																	}
																	;(a = x(a * x(17014118346046923e22))),
																		(qi = (((0 | qi) < 381 ? qi : 381) + -254) | 0)
																} else
																	-127 < (0 | qi) ||
																		...
																		(qi =
																			-253 < (0 | qi)
																				? (qi + 126) | 0
																				: ((a = x(a * x(11754943508222875e-54))),
																				  ((-378 < (0 | qi) ? qi : -378) + 252) | 0)))
																return x(a * (f(0, (1065353216 + (qi << 23)) | 0), k()))
														  })(a, mi)
														: (f(0, gi), k())),
												(a = x(x(1) * a))
										} else a = x(1)
								...
								return (function(a, qi, si) {
									...
									return (
										...
										(a =
											((65535 &
												(ti =
													(((wi = w((vi = 65535 & si), (a &= 65535))) >>> 16) + w(ti, vi)) | 0)) +
												w(a, ui)) |
											0),
										(M = (((((xi + w(qi, si)) | 0) + (ti >>> 16)) | 0) + (a >>> 16)) | 0),
										(65535 & wi) | (a << 16)
									)
								})(a, qi, si)
							}
										...
										b: {
											c: {
												d: {
													e: {
														f: {
															g: {
																...
																Ci = (0 - (Bi = (((z(yi) + 33) | 0) - z(zi)) | 0)) | 0
																break c
															}
															return dc(0, (zi - w((a = ((zi >>> 0) / 0) | 0), 0)) | 0), (M = 0), a
														}
													...
													return (
														(si = 31 & (yi = yi ? (31 - z((yi + -1) ^ yi)) | 0 : 32)),
														(a =
															32 <= (63 & yi) >>> 0
																? ((zi = 0), qi >>> si)
																: ((zi = qi >>> si),
																  ((((1 << si) - 1) & qi) << (32 - si)) | (a >>> si))),
														(M = zi),
														a
													)
												}
											...
											if (
												...
												(Ai =
													32 <= zi >>> 0
														? ((zi = 0), yi >>> Ai)
														: ((zi = yi >>> Ai),
														  ((((1 << Ai) - 1) & yi) << (32 - Ai)) | (a >>> Ai))),
												(yi = 31 & (Ci &= 63)),
												32 <= Ci >>> 0
													? ((qi = a << yi), (a = 0))
													: ((qi = (((1 << yi) - 1) & (a >>> (32 - yi))) | (qi << yi)), (a <<= yi)),
												Bi)
											)
												for (
													(Ci = (si + (yi = -1)) | 0) >>> 0 < 4294967295 && (yi = 0);
													(Ai =
														((Ei = Di = (Ai << 1) | (qi >>> 31)) -
															(Fi =
																si &
											...
											return dc(Ai, zi), (M = (qi << 1) | (a >>> 31)), Di | (a << 1)
										}
										dc(a, qi), (qi = a = 0)
									}
									return (M = qi), a
				...
				var fa = Error,
					WebAssembly = {}
				;(F = []), 'object' != typeof WebAssembly && E('no native wasm support detected')
				var I,
					J = new (function(a) {
						var c = Array(17)
						return (
				...
				function ja(a, c, d) {
					var e = c + d
					for (d = c; a[d] && !(e <= d); ) ++d
					if (16 < d - c && a.subarray && ia) return ia.decode(a.subarray(c, d))
					for (e = ''; c < d; ) {
						var f = a[c++]
						if (128 & f) {
							var g = 63 & a[c++]
							if (192 == (224 & f)) e += String.fromCharCode(((31 & f) << 6) | g)
							else {
								var m = 63 & a[c++]
								;(f =
									224 == (240 & f)
				...
				var P = 0,
					...
					U = null
				function B(a) {
					throw (b.onAbort && b.onAbort(a),
					D(a),
					E(a),
					(K = !0),
					new fa('abort(' + a + '). Build with -s ASSERTIONS=1 for more info.'))
				}
				...
				var H = {
						...
						emscripten_resize_heap: function(a) {
							...
							for (var c = Math.max(M.length, 16777216); c < a; )
								c = c <= 536870912 ? la(2 * c) : Math.min(la((3 * c + 2147483648) / 4), 2147418112)
							a: {
								try {
							...
							try {
								for (var f = 0, g = 0; g < d; g++) {
									for (
										...
										var R = L[m + A],
											S = xa[a]
										0 === R || 10 === R ? ((1 === a ? D : E)(ja(S, 0)), (S.length = 0)) : S.push(R)
									}
									f += h
								}
								return (N[e >> 2] = f), 0
							} catch (T) {
								return ('undefined' != typeof FS && T instanceof FS.c) || B(T), T.f
							}
						},
						memory: I,
						table: J,
					...
					Aa = (function() {
						function a(a) {
							;(b.asm = a.exports),
								...
								0 == P &&
									(null !== Q && (clearInterval(Q), (Q = null)), U && ((a = U), (U = null), a()))
						}
						function c(c) {
							a(c.instance)
						}
						function d(a) {
							return (F || (!p && !q) || 'function' != typeof fetch
				...
				function Z() {
					function a() {
						if (!Y && ((Y = !0), !K)) {
							if ((O(oa), O(pa), b.onRuntimeInitialized && b.onRuntimeInitialized(), b.postRun))
								for (
					...
					if (!(0 < P)) {
						if (b.preRun)
							for ('function' == typeof b.preRun && (b.preRun = [b.preRun]); b.preRun.length; ) ra()
						O(na),
							0 < P ||
								(b.setStatus
									? (b.setStatus('Running...'),
									...
									if (null != a && 0 !== a) {
										...
										if (0 < d) {
											...
											for (var g = 0; g < a.length; ++g) {
												...
												if (55296 <= k && k <= 57343)
													k = (65536 + ((1023 & k) << 10)) | (1023 & a.charCodeAt(++g))
												if (k <= 127) {
													if (d <= e) break
													f[e++] = k
												} else {
